...
$script:ServiceAutoChart02.Series["Running Services Per Host"].Color             = 'Blue'
        ...
        function Generate-ServicesAutoChart02 ($Filter) {
            ...
            $script:ServiceAutoChart02UniqueDataFields = $script:ServiceAutoChartDataSourceServices | Where-Object {$_.State -eq "$Filter" -or $_.Status -eq "$Filter"} | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Property 'Name'
