...
Get-ProcessTree -Verbose | select  @{name="PSComputerName";expression={$env:COMPUTERNAME}}, Level, ProcessId, ProcessNameIndented, ParentPID, ParentProcessName, CreationDate, WorkingSetSize, ProcessName
