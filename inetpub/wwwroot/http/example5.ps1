...
# 	$value = (Get-Date)
# }
# # Example: http://localhost:8080/example5.ps1?command=Hostname
# if ($cmd -eq "Hostname") {
# 	$value = ($env:COMPUTERNAME)
# }

$value = Invoke-Expression "$($PoSHQuery.Command)"

@"
$(Write-Host PoSh-EasyWin WebUI - Alpha Testing ))
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>PoSh-EasyWin WebUI - Alpha Testing</title>
    ...
    <div class="container_12">
        ...
        <div class="grid_3 alpha">
            ...
            <div class="fixed-column">
                ...
                <a href="index.htm" title="home page">
                    <img src="images/\PoSh-EasyWin.png" alt="logo" class="logo" />
                </a>
                <!-- END LOGO -->
                ...
                <ul id="nav">
                    ...
                    <li><a href="#Interactions" title="Interactions">Interactions</a></li>
                    <li><a href="#Enumeration" title="Enumeration">Enumeration</a></li>
                    <li><a href="#OpNotes" title="OpNotes">OpNotes</a></li>
                    <li><a href="#Endpoints" title="Endpoints">Endpoints</a></li>
                ...
                <a href="#" title="Under Construction">
                    <img src="images/Under-Construction.png" alt="Under Construction" class="Under-Construction" />
                </a>
                ...
                <div class="credits">
                    ...
                    Powered by:<br>
                    <a href="https://github.com/high101bro/PoSh-EasyWin" title="PoSh-EasyWin">
                         high101bro
                    </a><br>
        ...
        <div class="grid_9 omega right-column">
            ...
            <div class="home">
                ...
                <h1>
                    <span>PoSH-EasyWin</span><br>
                    ...a Web UX coming to a<br>
                    browser near you!<br>
                    <br>
                    <span>Command Output:</span><br>
                    $($value)
                </h1>
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyIZzqHjWAbeDOyaE9kj9pLo/
# cMKgggM6MIIDNjCCAh6gAwIBAgIQeugH5LewQKBKT6dPXhQ7sDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUfvWzM3ond4D71buBkvxXhcGYWVUwDQYJKoZI
# hvcNAQEBBQAEggEAfBsVvIryX2p6iXlSWfNyw/2lSWTuTyfMhapTAR8XbfHCmuij
# 2qIb10SQRLuTPu/4WlCUeVzxHWQ7r8AhCcogAqtFGiQ3GEAchX8mnqwWHrpjUT8d
# YKXkzO9Ycg4Un6P01KG36fuadWPBdihUrxvkFyQ+lB90Hs+ip5l8K/mT4xVmRjS9
# NcCP8OuaPPtIOpm3fEiWBfcUe8+ZViYIgByyGK6mq7dQa2fhrdeb/z0T5mnE8vKE
# chiGmP/I5VWBc/jiaAtQz2MUrEVw73XdMR8umDrhFCsgp0NNyRznQtWmKPvl7GkR
# CreHNCjt/rqRKBEux1qAoXyDV3mqsLq2Stq3Rw==
