...
if ( Test-Path -Path $CustomWinRMCommands ) { $script:ImportCustomCommands = Import-Csv -Path $CustomWinRMCommands }
    ...
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value 'System, Hunt'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_PoSh     -Value 'Get-Process'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value 'Get-WmiObject -Class Win32_Process'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value 'winrs wmic process list brief'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value 'winrs tasklist /V /FO CSV'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_Script -Value $null
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value 'Invoke-Command -ScriptBlock { Get-Process }'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value 'Invoke-Command -ScriptBlock { Get-WmiObject -Class Win32_Process }'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd /c tasklist /V /FO CSV }'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value '@{name="PSComputerName";expression={$TargetComputer}}, Name, ID, Path, StartTime, @{name="WorkingSetSize";expression={$_.WS}} , Handle, HandleCount, @{Name="ThreadCount";expression={($_.Threads).count}}, Company, Product, Description'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value 'PSComputerName, Name, ProcessID, ParentProcessID, Path, WorkingSetSize, Handle, HandleCount, ThreadCount, CreationDate, Description'
    $ExampleCommand | Add-Member -MemberType NoteProperty -Name Message              -Value 'Gets a list of running processes.'
...
$Section1TabControl.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1CollectionsTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1CollectionsTabControl.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1CommandsTab.Text      = "Queries"
...
$Section1CommandsTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:AllEndpointCommands = @()
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_PoSh     -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_Script -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value "Invoke-Command -ScriptBlock { Get-LocalGroupMember -Group administrators }"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value "Invoke-Command -ScriptBlock { cmd /c net localgroup administrators }"
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value "winrs net localgroup administrators"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value '@{name="PSComputerName";expression={$TargetComputer}},Name, SID, ObjectClass, PrincipalSource'
    ...
    $CommandScript ={
        ...
        foreach ($Driver in $Drivers) {
            ...
            $HashMD5 = $(Get-FileHash -Path $Driver.OriginalFileName -Algorithm MD5).Hash
            $Driver | Add-Member -NotePropertyName HashMD5 -NotePropertyValue $HashMD5
            ...
            $HashSHA256 = $(Get-FileHash -Path $Driver.OriginalFileName -Algorithm SHA256).Hash
            ...
            $Driver | Select PSComputerName, Online, ClassName, Driver, OriginalFileName, ClassDescription, BootCritical, HashMD5, HashSHA256, DriverSignature, SignerCertificate, Status, ProviderName, Date, Version, InBox, LogPath, LogLevel
        }
    }
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "System" 
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value 'driverquery /si /FO CSV'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_PoSh     -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value 'PSComputerName, Online, ClassName, Driver, OriginalFileName, ClassDescription, BootCritical, DriverSignature, ProviderName, Date, Version, InBox, LogPath, LogLevel' 
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_Script -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value 'Invoke-Command -ScriptBlock { Get-WmiObject -Class Win32_Printer }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value 'Get-WmiObject -Class Win32_Printer'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_winrs        -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value 'PSComputerName, Name, Status, Shared, Local, Network, SpoolEnabled, KeepPrintedJobs, DriverName, Default, Location'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Message              -Value "____"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name NotesPath            -Value "$CommandsHostDirectoryNotes\$CollectionName.txt"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name ExportFileName       -Value "$CollectionName"
    $script:AllEndpointCommands += $BuildCommand
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name NotesPath            -Value '$CommandsHostDirectoryNotes\$CollectionName.txt'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name ExportFileName       -Value "$IndividualHostResults\$CollectionName\$CollectionName"
    $script:AllEndpointCommands += $BuildCommand
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value "winrs tasklist /V /FO CSV"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_Script -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value "Invoke-Command -ScriptBlock { cmd c\ dism /online /get-packages }"
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value '@{name="PSComputerName";expression={$TargetComputer}}, Status, Name, DisplayName, RequiredServices, StartType, CanPauseAndContinue, CanShutdown, CanStop, ServiceHandle' 
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value 'PSComputerName, State, Name, ProcessID, Description, PathName, Started, StartMode, StartName' 
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value "winrs tasklist /SVC /FO CSV"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_Script -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value "Invoke-Command -ScriptBlock { cmd /c tasklist /SVC /FO CSV }"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Message              -Value "Displays with the services hosted in each process."
    $BuildCommand | Add-Member -MemberType NoteProperty -Name NotesPath            -Value "$CommandsHostDirectoryNotes\$CollectionName.txt"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name ExportFileName       -Value "$CollectionName"
    $script:AllEndpointCommands += $BuildCommand
...
#=============================
    ...
    $CollectionName = 'Accounts (Logon and Passowrd Policy)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Accounts (Contact Information)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Accounts (Disabled)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ dsquery user -disabled }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    ...
    $CollectionName = 'Accounts (Expired)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Accounts (Inactive)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ dsquery user domainroot -inactive 4 }' #Accounts That Are Inactive for Longer Than 4 Weeks
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value 'Name, Enabled, LockedOut, LastLogonDate, AccountExpirationDate, PasswordExpired, PaswordNeverExpires, SID, SamAccountName, UserPrincipalName, DistinguishedName, ObjectClass, ObjectGUID'
    ...
    $CollectionName = 'Accounts (Password Never Expires)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Controllers (All of them)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    ...
    $CollectionName = 'Domain Controllers (Primary)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Controllers (That are Global Catalogs)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Controllers (Read Only Domain Controllers [RODC])'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain FSMO Roles'
    $CommandScript = {
    ...
    $CollectionName = 'Domain FSMO (Schema Master in Forest)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain FSMO (Domain Naming Master)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain FSMO (Primary Domain Controller)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain FSMO (RID Master)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain FSMO (Infrastructure Master)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Organizationation Units (OUs)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Servers (All of them)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ netdom query server }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Message              -Value 'Lists all domain joined servers.'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name NotesPath            -Value "$CommandsHostDirectoryNotes\ADDS - $CollectionName.txt"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name ExportFileName       -Value "$CollectionName"
    $script:AllActiveDirectoryCommands += $BuildCommand


    $CollectionName = 'Domain Sites'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Domain Workstations (All of them)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ netdom query workstation }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_WMI       -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Message              -Value 'Lists all domain joined workstations.'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name NotesPath            -Value "$CommandsHostDirectoryNotes\ADDS - $CollectionName.txt"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name ExportFileName       -Value "$CollectionName"
    $script:AllActiveDirectoryCommands += $BuildCommand


    $CollectionName = 'Group (Primary Group is Domain Computers)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Group (Primary Group is Domain Controllers)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Group (Primary Group is Domain Users)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ dsquery * -filter "(primaryGroupID=513)" -limit 0 }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    ...
    $CollectionName = 'Group (Primary Group is Guests)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_PoSh   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_WMI    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRM_CMD    -Value 'Invoke-Command -ScriptBlock { cmd c\ dsquery * -filter "(primaryGroupID=514)" -limit 0 }'
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WMI          -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_WMIC   -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_WinRS_CMD    -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Properties_PoSh      -Value $null
    ...
    $CollectionName = 'Get All Object Classes'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "Domain"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Computers (Details and OS Info)'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Default Domain Password Policy'
    $BuildCommand = New-Object PSObject -Property @{ Name = $CollectionName }
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Type                 -Value "User"
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD      -Value $null
    $BuildCommand | Add-Member -MemberType NoteProperty -Name Command_RPC_CMD_Arg  -Value $null
    ...
    $CollectionName = 'Group Membership by Users'
    $CommandScript = {
    ...
    $CollectionName = 'Groups Without Account Members'
    $CommandScript = {
        Get-ADGroup -filter * `
...
#        }
    ...
    Foreach ($Command in $script:ImportCustomCommands) {
        if ($Command.Command_RPC_PoSh) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category 'Remote Procedure Call (RPC) PoSh' -Entry "(RPC) PoSh -- $($Command.Name)" -ToolTip $Command.Command_RPC_PoSh
        }
        if ($Command.Command_RPC_CMD) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category 'Remote Procedure Call (RPC) Win CMD' -Entry "(RPC) CMD -- $($Command.Name)" -ToolTip $Command.Command_RPC_CMD
        }
        if ($Command.Command_WMI) {
...
#        }
        ...
        if ($Command.Command_WinRM_PoSh) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category 'PowerShell Remoting (WinRM) PoSh' -Entry "(WinRM) PoSh -- $($Command.Name)" -ToolTip $Command.Command_WinRM_PoSh
        }
        if ($Command.Command_WinRM_WMI) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category 'PowerShell Remoting (WinRM) WMI' -Entry "(WinRM) WMI -- $($Command.Name)" -ToolTip $Command.Command_WinRM_WMI
        }
        if ($Command.Command_WinRM_CMD) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category 'PowerShell Remoting (WinRM) Win CMD' -Entry "(WinRM) CMD -- $($Command.Name)" -ToolTip $Command.Command_WinRM_CMD
        }
    }
}
...
#        }
    ...
    Foreach ($Command in $script:ImportCustomCommands) {
        ...
        if ($Command.Command_WMI) {
            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category $Command.Name -Entry "(WMI) -- $($Command.Name)" -ToolTip $Command.Command_WMI
        }
#        if ($Command.Command_WinRS_WMIC) {
#            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category $Command.Name -Entry "(WinRS) WMIC -- $($Command.Name)" -ToolTip $Command.Command_WinRS_WMIC
#        }
#        if ($Command.Command_WinRS_CMD) {
#            Add-CommandsNode -RootNode $script:TreeNodeImportCustomCommands -Category $Command.Name -Entry "(WinRS) CMD -- $($Command.Name)" -ToolTip $Command.Command_WinRS_CMD
#        }
        if ($Command.Command_WinRM_Script) {
...
$System_Drawing_Size.Height  = 479
$CommandsTreeView.Size       = $System_Drawing_Size
$System_Drawing_Point        = New-Object System.Drawing.Point
$System_Drawing_Point.X      = 0
$System_Drawing_Point.Y      = 50
$CommandsTreeView.Location   = $System_Drawing_Point
$CommandsTreeView.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1EventLogsTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsMainLabel.Font      = New-Object System.Drawing.Font("$Font",10,1,3,1)
...
$EventLogsEventIDsManualEntryCheckbox.Name     = "Event IDs Manual Entry (WMI)"
...
$EventLogsEventIDsManualEntryCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
if (Test-Path $EventIDsFile) {
    ...
    $EventLogsEventIDsManualEntrySelectionButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsEventIDsManualEntryLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
if (Test-Path -Path $EventLogsWindowITProCenter) {
    ...
    $EventLogsEventIDsIndividualSelectionCheckbox.Name     = "Event IDs Individual Selection (WMI)"
    ...
    $EventLogsEventIDsIndividualSelectionCheckbox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $EventLogsEventIDsIndividualSelectionClearButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $EventLogsEventIDsIndividualSelectionLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsQuickPickSelectionCheckbox.Name     = "Event IDs Quick Selection (WMI)"
...
$EventLogsQuickPickSelectionCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsQuickPickSelectionClearButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsQuickPickSelectionLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EventLogsQuickPickSelectionCheckedlistbox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    foreach ($TargetComputer in $ComputerList) {
        ...
        if ($ComputerListProvideCredentialsCheckBox.Checked -eq $true) {
            ...
            Start-Job -Name "PoSh-ACME: $CollectionName -- $TargetComputer" -ScriptBlock {
                ...
                | Select-Object PSComputerName, EventCode, LogFile, TimeGenerated, Message, @{Name="InsertionStrings"; Expression={$_.InsertionStrings}}, Type `
...
$Section1FileSearchTab.Text     = "File, Hash, and ADS Search"
...
$Section1FileSearchTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    foreach ($TargetComputer in $ComputerList) {
        ...
        if ($ComputerListProvideCredentialsCheckBox.Checked -eq $true) {
            ...
            Start-Job -Name "PoSh-ACME: $($CollectionName) -- $($TargetComputer)" -ScriptBlock {
                ...
                $FilesFoundList += $FilesFound | Select-Object -Property PSComputerName, Directory, Name, HashMD5, HashSHA256, BaseName, Extension, Attributes, CreationTime, LastWriteTime, LastAccessTime, FullName
...
$FileSearchDirectoryListingCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchDirectoryListingMaxDepthLabel.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchDirectoryListingMaxDepthTextbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchDirectoryListingLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchDirectoryListingTextbox.WordWrap      = $false
$FileSearchDirectoryListingTextbox.Text          = "C:\Windows\System32"
$FileSearchDirectoryListingTextbox.AutoCompleteSource = "FileSystem" # Options are: FileSystem, HistoryList, RecentlyUsedList, AllURL, AllSystemSources, FileSystemDirectories, CustomSource, ListItems, None
$FileSearchDirectoryListingTextbox.AutoCompleteMode   = "SuggestAppend" # Options are: "Suggest", "Append", "SuggestAppend"#$FileSearchDirectoryListingTextbox.Add_KeyDown({          })
$FileSearchDirectoryListingTextbox.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
function FileSearchFileSearchCommand {
    ...
    foreach ($TargetComputer in $ComputerList) {
        ...
        if ($ComputerListProvideCredentialsCheckBox.Checked -eq $true) {
            ...
            Start-Job -Name "PoSh-ACME: $($CollectionName) -- $($TargetComputer)" -ScriptBlock {
                param($DirectoriesToSearch, $FilesToSearch, $TargetComputer, $DirectoryPath, $Filename, $MaximumDepth, $FileHashSelection, $IndividualHostResults, $CollectionName)
                [System.Threading.Thread]::CurrentThread.Priority = 'High'
                ([System.Diagnostics.Process]::GetCurrentProcess()).PriorityClass = 'High'
...
#Batman
                ...
                foreach ($DirectoryPath in $DirectoriesToSearch) {
                    foreach ($Filename in $FilesToSearch) {
                        $FilesFound = Invoke-Command -ComputerName $TargetComputer -ScriptBlock {
                            param($DirectoryPath, $Filename, $MaximumDepth, $FileHashSelection, $TargetComputer)
                            ...
                            Function Get-ChildItemRecurse {
                                ...
                                $CurrentDepth++
                                $RecursiveListing = New-Object PSObject
                                Get-ChildItem -Path $Path -Filter $Filter -Force | Foreach { 
                                    $RecursiveListing | Add-Member -MemberType NoteProperty -Name PSComputerName -Value $TargetComputer -Force
                                    #$RecursiveListing | Add-Member -MemberType NoteProperty -Name DirectoryName -Value $_.DirectoryName -Force
                                    $RecursiveListing | Add-Member -MemberType NoteProperty -Name Directory -Value $_.Directory -Force
                                    $RecursiveListing | Add-Member -MemberType NoteProperty -Name Name -Value $_.Name -Force
                                    ...
                                    if ($FileHashSelection -match 'MD5') {
                                        $HashMD5          = $(Get-FileHash -Path $_.FullName -Algorithm MD5).Hash
                                        $RecursiveListing | Add-Member -MemberType NoteProperty -Name HashMD5 -Value $HashMD5 -Force
                                    }
                                    if ($FileHashSelection -match 'SHA1') {
                                        $HashSHA1       = $(Get-FileHash -Path $_.FullName -Algorithm SHA1).Hash
                                        $RecursiveListing | Add-Member -MemberType NoteProperty -Name HashSHA1 -Value $HashSHA1 -Force
                                    }
                                    if ($FileHashSelection -match 'SHA256') {
                                        $HashSHA256       = $(Get-FileHash -Path $_.FullName -Algorithm SHA256).Hash
                                        $RecursiveListing | Add-Member -MemberType NoteProperty -Name HashSHA256 -Value $HashSHA256 -Force
                                    }
                                    if ($FileHashSelection -match 'SHA512') {
                                        $HashSHA512       = $(Get-FileHash -Path $_.FullName -Algorithm SHA512).Hash
                                        $RecursiveListing | Add-Member -MemberType NoteProperty -Name HashSHA512 -Value $HashSHA512 -Force
                                    }
                                    If ($_.PsIsContainer) {
                                        If ($CurrentDepth -le $Depth) {                
                                            # Callback to this function
                        ...
                        Get-ChildItemRecurse -Path $Path -Depth $MaxDepth | Where-Object { ($_.PSIsContainer -eq $false) -and (($_.Name -match "$Filename") -or ($_.HashMD5 -match "$Filename") -or ($_.HashSHA1 -match "$Filename") -or ($_.HashSHA256 -match "$Filename") -or ($_.HashSHA512 -match "$Filename")) }

                        } -ArgumentList @($DirectoryPath, $Filename, $MaximumDepth, $FileHashSelection, $TargetComputer)
                        
                        $FilesFoundList += $FilesFound | Select-Object -Property PSComputerName, Directory, Name, HashMD5, HashSHA1, HashSHA256, HashSHA512, BaseName, Extension, Attributes, CreationTime, LastWriteTime, LastAccessTime, FullName
                    }
                }
                $FilesFoundList | Export-CSV "$($IndividualHostResults)\$($CollectionName)\$($CollectionName)-$($TargetComputer).csv" -NoTypeInformation
            } -ArgumentList @($DirectoriesToSearch, $FilesToSearch, $TargetComputer, $DirectoryPath, $Filename, $MaximumDepth, $FileHashSelection, $IndividualHostResults, $CollectionName)
        } 
    }
    Monitor-Jobs -CollectionName $CollectionName
    $CollectionCommandEndTime  = Get-Date                    
...
$FileSearchFileSearchCheckbox.Text     = "File Search (WinRM)"
...
$FileSearchFileSearchCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchFileSearchMaxDepthLabel.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchFileSearchMaxDepthTextbox.Font           = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchFileSearchLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
#cannot do both# $FileSearchFileSearchFileTextbox.ScrollBars    = "Horizontal"
$FileSearchFileSearchFileTextbox.WordWrap      = $false
...
$FileSearchFileSearchFileTextbox.AllowDrop     = $true
$FileSearchFileSearchFileTextbox.Text          = "Enter FileNames - One Per Line"
#$FileSearchFileSearchFileTextbox.AutoCompleteSource = "FileSystem" # Options are: FileSystem, HistoryList, RecentlyUsedList, AllURL, AllSystemSources, FileSystemDirectories, CustomSource, ListItems, None
#$FileSearchFileSearchFileTextbox.AutoCompleteMode   = "SuggestAppend" # Options are: "Suggest", "Append", "SuggestAppend"
#$FileSearchFileSearchFileTextbox.Add_KeyDown({          })
$FileSearchFileSearchFileTextbox.Font           = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchAlternateDataStreamCheckbox.Font           = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$FileSearchAlternateDataStreamLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1SysinternalsTab.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsTabLabel.Text      = "The following queries drop/remove files to the target host's temp dir.`nPoSh-ACME must be ran with elevated credentials for these to function.`nThese queries to target hosts are not threaded."
$SysinternalsTabLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsAutorunsLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsAutorunsButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
function SysinternalsAutorunsCommand {
    ...
    foreach ($TargetComputer in $ComputerList) {
        ...
        Function SysinternalsAutorunsData {
            ...
            try { Copy-Item $SysinternalsExecutablePath "\\$TargetComputer\$AdminShare\$TargetFolder" -Force -ErrorAction Stop } catch { $ResultsListBox.Items.Insert(2,"$((Get-Date).ToString('yyyy/MM/dd HH:mm:ss'))   [!] $($_.Exception)"); break }
...
$SysinternalsAutorunsCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsProcessMonitorLabel.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsProcmonButton.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsProcessMonitorCheckbox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$SysinternalsProcessMonitorTimeTextBox.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1EnumerationTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EnumerationDomainGenerateDownPositionShift = 25
    ...
    $EnumerationDomainGeneratedLabelNote.Font      = New-Object System.Drawing.Font("$Font",10,0,0,0)
    ...
    $EnumerationDomainGeneratedAutoCheckBox.Font      = New-Object System.Drawing.Font("$Font",10,0,0,0)
    ...
    $EnumerationDomainGeneratedTextBox.Font      = New-Object System.Drawing.Font("$Font",10,0,0,0)
    ...
    $EnumerationDomainGeneratedListButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$EnumerationComputerListBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1ChecklistTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1ChecklistTabControl.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
foreach ($File in $ResourceChecklistFiles) {
    ...
    $Section1ChecklistSubTab.Text       = $File.BaseName
    $Section1ChecklistSubTab.AutoScroll = $True
    $Section1ChecklistSubTab.UseVisualStyleBackColor = $True
    $Section1ChecklistSubTab.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    foreach ($line in $TabContents) {
        ...
        $Checklist.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1ProcessesTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1ProcessesTabControl.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
foreach ($File in $ResourceFiles) {
    ...
    $Section1ProcessesSubTab.Text              = $File.BaseName
    $Section1ProcessesSubTab.UseVisualStyleBackColor = $True
    $Section1ProcessesSubTab.Font              = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $Section1ProcessesSubTabTextBox.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1OpNotesTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesInputTextBox.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesAddButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesOpenListBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesMoveUpButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesRemoveButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesCreateReportButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesMoveDownButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OpNotesListBox.Font                = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1AboutTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section1AboutTabControl.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
foreach ($File in $ResourceFiles) {
    ...
    $Section1AboutSubTab.Text              = $File.BaseName
    $Section1AboutSubTab.UseVisualStyleBackColor = $True
    $Section1AboutSubTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $Section1AboutSubTabTextBox.Font      = New-Object System.Drawing.Font("Courier New",9,0,0,0)
...
function AutoChartsSelectOptions {
    ...
    $AutoChartsSelectionForm.Font   = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $AutoChartsMainLabel.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    $AutoChartsSeriesGroupBox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
        ...
        $AutoChartsPreviousCheckBox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
        ...
        $AutoChartsMostRecentCheckBox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ...
    if ($AutoChartSelectChartComboBox.SelectedItem -notmatch "All Charts") {
        ...
        if ($AutoChartsPreviousCheckBox.Checked -eq $True) {
            if ($script:CSVFilePreviousCollection) {
                ...
                $AutoChartsSeries2Results.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section2OptionsTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OptionLogButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:OptionJobTimeoutSelectionComboBox.Text     = 600
...
$OptionJobTimeoutSelectionComboBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OptionJobTimeoutSelectionLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OptionSearchProcessesCheckBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$OptionBoldTreeViewCategoriesCheckBox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
# Option - Show ToolTip
#-----------------------
$OptionShowToolTipCheckBox          = New-Object System.Windows.Forms.Checkbox
$OptionShowToolTipCheckBox.Text     = "Show ToolTip"
$OptionShowToolTipCheckBox.Location = New-Object System.Drawing.Size(3,($OptionBoldTreeViewCategoriesCheckBox.Location.Y + $OptionBoldTreeViewCategoriesCheckBox.Size.Height + 5))
$OptionShowToolTipCheckBox.Size     = New-Object System.Drawing.Size(200,$Column3BoxHeight) 
...
$OptionTextToSpeachCheckBox.Location = New-Object System.Drawing.Size(3,($OptionShowToolTipCheckBox.Location.Y + $OptionShowToolTipCheckBox.Size.Height + 5))
...
$OptionTextToSpeachCheckBox.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewSearchTextBox.Font        = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewOSHostnameRadioButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewOUHostnameRadioButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3TabControl.Font          = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3ActionTab.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListPingButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListWinRMCheckButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListRPCCheckButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListPsExecButton.Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListPSSessionButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListProvideCredentialsCheckBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ProvideCredsButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3ManageListTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewImportCsvButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewImportTxtButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewAddHostnameIPButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ComputerListTreeViewAddHostnameIPButton.Add_Click({
    ...
    $ComputerListTreeViewPopupOUComboBox.Text               = "Select an Organizational Unit / Canonical Name (or type a new one)"
...
$ComputerListMoveButton.Add_Click({
    ...
    if ($ComputerListCheckedBoxesSelected.count -ge 1) {
        ...
        $ComputerListTreeViewPopupMoveComboBox.AutoCompleteSource = "ListItems" # Options are: FileSystem, HistoryList, RecentlyUsedList, AllURL, AllSystemSources, FileSystemDirectories, CustomSource, ListItems, None
        $ComputerListTreeViewPopupMoveComboBox.AutoCompleteMode   = "SuggestAppend" # Options are: "Suggest", "Append", "SuggestAppend"
        ...
        $ComputerListTreeViewPopupMoveComboBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$StatusLabel.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$StatusListBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ProgressBar1Label.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ProgressBar2Label.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section4TabControl.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3ResultsTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ResultsTabOpNotesAddButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$ResultsListBox.Font                = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$Section3HostDataTab.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
#----------------------------------
    ...
    # MAC Address TextBox
    $Section3HostDataMAC          = New-Object System.Windows.Forms.TextBox
    $Section3HostDataMAC.Location = New-Object System.Drawing.Size(($Section3HostDataIP.Size.Width + 10),($Section3HostDataOU.Location.Y + $Section3HostDataOU.Size.Height + 4)) 
...
$Section3HostDataNotes.Font       = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3HostDataSaveButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$HostDataList2 = {
    ...
    $Section3HostDataSelectionComboBox.Text               = "Host Data - Selection"
    $Section3HostDataSelectionComboBox.Font               = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
⦿ Note: Datetimes with more than one collection type won't
    ...
    $Section3HostDataSelectionDateTimeComboBox.Text               = "Host Data - Date & Time"
    $Section3HostDataSelectionDateTimeComboBox.Font               = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3HostDataTagsComboBox.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$Section3HostDataTagsAddButton.Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
