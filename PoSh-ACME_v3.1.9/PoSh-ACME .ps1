...
$PoShACME = New-Object System.Windows.Forms.Form -Property @{
    ...
    Size          = New-Object System.Drawing.Size($PoShACMEBoxWidth,$PoShACMEBoxHeight)
    AutoScroll    = $True
...
function AutoChartsSelectOptions {
    ...
    function AutoChartsViewCharts {
        ...
        elseif ($AutoChartSelectChartComboBox.SelectedItem -notin $AutoChartsAvailable) {
            ...
            # Accounts
            if     ($AutoChartSelectChartComboBox.SelectedItem -match "Local User Accounts") { Generate-AutoChartsCommand -QueryName "Local Users" -QueryTabName "Local User Accounts" -PropertyX Name -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Local Accounts per Endpoint") { Generate-AutoChartsCommand -QueryName "Local Users" -QueryTabName "Local Accounts per Endpoint" -PropertyX PSComputerName -PropertyY Name -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Interface / Network Settings
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Interface Alias") { Generate-AutoChartsCommand -QueryName "Network Settings" -QueryTabName "Interface Alias" -PropertyX InterfaceAlias -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Interfaces with IPs per Endpoint") { Generate-AutoChartsCommand -QueryName "Network Settings" -QueryTabName "Interfaces with IPs per Endpoint" -PropertyX PSComputerName -PropertyY IPAddress -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Mapped Drives
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Disk Drives by Model") { Generate-AutoChartsCommand -QueryName "Disk - Physical Info" -QueryTabName "Disk Drives by Model" -PropertyX PSComputerName -PropertyY Model -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Disk Drive Models per Endpoint") { Generate-AutoChartsCommand -QueryName "Disk - Physical Info" -QueryTabName "Disk Drive Models per Endpoint" -PropertyX Model -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Mapped Drives by Device ID") { Generate-AutoChartsCommand -QueryName "Get-MappedDrives" -QueryTabName "Mapped Drives by Device ID" -PropertyX PSComputerName -PropertyY DeviceID -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Mapped Drive Device IDs per Endpoint") { Generate-AutoChartsCommand -QueryName "Get-MappedDrives" -QueryTabName "Mapped Drive Device IDs per Endpoint" -PropertyX DeviceID -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Mapped Drives by Volume Name") { Generate-AutoChartsCommand -QueryName "Get-MappedDrives" -QueryTabName "Mapped Drives by Volume Name" -PropertyX PSComputerName -PropertyY VolumeName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Mapped Drive Volume Names per Endpoint") { Generate-AutoChartsCommand -QueryName "Get-MappedDrives" -QueryTabName "Mapped Drive Volume Names per Endpoint" -PropertyX VolumeName -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Processes
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Names") { Generate-AutoChartsCommand -QueryName "Processes" -QueryTabName "Process Names" -PropertyX Name -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Paths") { Generate-AutoChartsCommand -QueryName "Processes" -QueryTabName "Process Paths" -PropertyX Path -PropertyY PSComputerName -ChartType1 'Bar'    -ChartType2_3 'Bar'   -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process MD5 Hashes") { Generate-AutoChartsCommand -QueryName "ProcessesEnhanced" -QueryTabName "Process MD5 Hashes" -PropertyX MD5Hash -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Company") { Generate-AutoChartsCommand -QueryName "Processes" -QueryTabName "Process Company" -PropertyX Company -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Product") { Generate-AutoChartsCommand -QueryName "Processes" -QueryTabName "Process Product" -PropertyX Product -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Processes per Endpoint") { Generate-AutoChartsCommand -QueryName "Processes" -QueryTabName "Processes per Endpoint" -PropertyX PSComputerName -PropertyY ProcessID -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
                elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Signer Certificate") { Generate-AutoChartsCommand -QueryName "ProcessesEnhanced" -QueryTabName "Process Signer Certificate" -PropertyX SignerCertificate -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
                elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Process Signer Company") { Generate-AutoChartsCommand -QueryName "ProcessesEnhanced" -QueryTabName "Process Signer Company" -PropertyX SignerCompany -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Services
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Services Names") { Generate-AutoChartsCommand -QueryName "Services" -QueryTabName "Running Service Names" -PropertyX Name     -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Services Paths") { Generate-AutoChartsCommand -QueryName "Services" -QueryTabName "Running Service Paths" -PropertyX PathName -PropertyY PSComputerName -ChartType1 'Bar'    -ChartType2_3 'Bar'   -MarkerStyle1 'None' -MarkerStyle2 'None'   -MarkerStyle3 'None' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Services per Endpoint") { Generate-AutoChartsCommand -QueryName "Services" -QueryTabName "Running Services per Endpoint" -PropertyX PSComputerName -PropertyY Name -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Security Patches
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Security Patches HotFixes") { Generate-AutoChartsCommand -QueryName "Security Patches" -QueryTabName "Security Patches Hotfix"    -PropertyX HotFixID -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Security Patches Service Packs In Effect") { Generate-AutoChartsCommand -QueryName "Security Patches" -QueryTabName "Service Packs In Effect" -PropertyX ServicePackInEffect -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Security Patches per Endpoint") { Generate-AutoChartsCommand -QueryName "Security Patches" -QueryTabName "Security Patches per Endpoint"   -PropertyX PSComputerName -PropertyY HotFixID -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Shares
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Share Names") { Generate-AutoChartsCommand -QueryName "Shares" -QueryTabName "Share Names" -PropertyX Name -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Share Paths") { Generate-AutoChartsCommand -QueryName "Shares" -QueryTabName "Share Paths" -PropertyX Path -PropertyY PSComputerName -ChartType1 'Bar'    -ChartType2_3 'Bar'   -MarkerStyle1 'None' -MarkerStyle2 'None'   -MarkerStyle3 'None' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Shares per Endpoint") { Generate-AutoChartsCommand -QueryName "Shares" -QueryTabName "Shares per Endpoint" -PropertyX PSComputerName -PropertyY Name -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Software Installed
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Software Installed by Names") { Generate-AutoChartsCommand -QueryName "Software Installed" -QueryTabName "Software Installed by Names" -PropertyX Name -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Software Installed by Vendors") { Generate-AutoChartsCommand -QueryName "Software Installed" -QueryTabName "Software Installed by Vendors"             -PropertyX Vendor -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Software Installed per Endpoint") { Generate-AutoChartsCommand -QueryName "Software Installed" -QueryTabName "Software Installed per Endpoint" -PropertyX PSComputerName -PropertyY Name -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }

            # Startup / Autoruns
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Startup Names") { Generate-AutoChartsCommand -QueryName "Startup Commands" -QueryTabName "Startup Names"    -PropertyX Name    -PropertyY PSComputerName -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Startup Commands") { Generate-AutoChartsCommand -QueryName "Startup Commands" -QueryTabName "Startup Commands" -PropertyX Command -PropertyY PSComputerName -ChartType1 'Bar'    -ChartType2_3 'Bar'   -MarkerStyle1 'None' -MarkerStyle2 'None'   -MarkerStyle3 'None' }
            elseif ($AutoChartSelectChartComboBox.SelectedItem -match "Startups per Endpoint") { Generate-AutoChartsCommand -QueryName "Startup Commands" -QueryTabName "Startups per Endpoint" -PropertyX PSComputerName -PropertyY Name -ChartType1 'Column' -ChartType2_3 'Point' -MarkerStyle1 'None' -MarkerStyle2 'Square' -MarkerStyle3 'Diamond' }
        }
    }
...
function Generate-AutoChartsCommand {
    ...
    if ($AutoChartsMostRecentCheckBox.Checked -eq $true) { $AutoChartTitle.Text = ($script:CSVFileMostRecentCollection.split('\'))[-1] -replace '.csv','' }
    elseif ($AutoChartsPreviousCheckBox.Checked -eq $true) { $AutoChartTitle.Text = ($script:CSVFilePreviousCollection.split('\'))[-1] -replace '.csv','' }
    elseif ($AutoChartsBaselineCheckBox.Checked -eq $true) { $AutoChartTitle.Text = ($CSVFileMostBaselineCollection.split('\'))[-1] -replace '.csv','' }
    else { $AutoChartTitle.Text = "`Missing Data!`n1). Run The Appropriate Query`n2). Ensure To Select At Least One Series" ; $AutoChartTitle.ForeColor = "Red" }
    ...
    # Later used to iterate through, if they're $null they'll be filtered out later
        ...
        foreach ($CSVFile in $csvfilelist) {
            ...
            if ($CsvFile -ne $null) {
                ...
                if ($CSVFile -match "Services") {
                    foreach ($UniqueHost in $script:CsvUniqueHosts) { 
                        $DataSource += Import-Csv $CSVFile | Where-Object { $_.PSComputerName -eq $UniqueHost } | Where-Object {$_.State -eq "Running" } 
                    }
                ...
                # This essentially ends up adding a +1 count to all exist fiends, but will be later subtracted later
                    ...
                    foreach ($UniqueHost in $script:CsvUniqueHosts) { 
                        $DataSource += $ImportCsvFile | Where-Object { $_.PSComputerName -eq $UniqueHost } 
                    }
                ...
                $AutoChartsProgressBar.Minimum = 0
                $AutoChartsProgressBar.Maximum = $UniqueDataFields.count
    ...
    elseif ($PropertyX -eq "PSComputerName") {   
        ...
        foreach ($CSVFile in $CsvFileList) {
            ...
            if ($CsvFile -ne $null) {
                ...
                else { $DataSource = Import-Csv $CSVFile }
...
$ComputerListTreeView.Add_Click({ Conduct-NodeAction -TreeView $ComputerListTreeView.Nodes -ComputerList })
$ComputerListTreeView.add_AfterSelect({ Conduct-NodeAction -TreeView $ComputerListTreeView.Nodes -ComputerList })
...
$ComputerListDeselectAllButton.Add_Click({   
    ...
    Conduct-NodeAction -TreeView $ComputerListTreeView.Nodes -ComputerList
})
