<#
    .SYNOPSIS
        Monitors endpoints and alerts if services are down or unresponsive.

        File Name      : Monitor-CredentialLogons.ps1
        Version        : v1.0
        Created        : 11 Nov 19
    ...
    .PARAMETER CsvInput
        ...
        The headers are: Name, Endpoint, Groups, Description
    ...
    .EXAMPLE
        This will run PoSh-ACME.ps1 and provide prompts that will tailor your collection.
             ...
             PowerShell.exe -ExecutionPolicy ByPass -NoProfile -File .\Monitor-CredentialLogons.ps1 -CsvInput

             PowerShell.exe -ExecutionPolicy ByPass -NoProfile -File .\Monitor-CredentialLogons.ps1 -CsvInput .\CustomFileName.csv

             PowerShell.exe -ExecutionPolicy ByPass -NoProfile -File .\Monitor-CredentialLogons.ps1 -RefreshRate 600
...
#>
param (
    $CsvInput = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)\Monitor-CredentialLogonsList.csv",
    $RefreshRate = 5,
    $Timeout_ms  = 500,
