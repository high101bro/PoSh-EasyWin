...
$script:AutoChartCSVFileMostRecentCollectionProcesses = $script:AutoChart01CSVFileMatch | Select-Object -Last 1
$script:AutoChartDataSourceProcesses = $null
$script:AutoChartDataSourceProcesses = Import-Csv $script:AutoChartCSVFileMostRecentCollectionProcesses
...
$AutoChartSelectFileButton.Add_Click({
    ...
    $AutoChartOpenResultsOpenFileDialog.Title            = "View Collection Results"
    ...
    $script:AutoChartDataSourceProcesses = Import-Csv $($AutoChartOpenResultsOpenFileDialog.filename)

    Generate-ProcessesAutoChart01
    Generate-ProcessesAutoChart02
    Generate-ProcessesAutoChart03
    Generate-ProcessesAutoChart04
    Generate-ProcessesAutoChart05
    Generate-ProcessesAutoChart06
    Generate-ProcessesAutoChart07
    Generate-ProcessesAutoChart08
    Generate-ProcessesAutoChart09
    Generate-ProcessesAutoChart10
})
...
$script:AutoChart01.Series["Unique Processes"].Color             = 'Red'
        ...
        function Generate-ProcessesAutoChart01 {
            $script:AutoChart01CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart01UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart01UniqueDataFields.count -gt 0){
                ...
                foreach ($DataField in $script:AutoChart01UniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceProcesses ) {
...
$script:AutoChart01OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart01.Location.X + 5
                   Y = $script:AutoChart01.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart01ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart01.Size.Height - 125 }
...
$script:AutoChart013DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart01ChartTypeComboBox.Location.X + $script:AutoChart01ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart01 {    
    ...
    $script:AutoChart01ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Name' -eq $($script:AutoChart01InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    $script:AutoChart01ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart01CheckDiffButton.Add_Click({
    $script:AutoChart01InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
$script:AutoChart01Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:AutoChart02.Series["Processes Per Host"].ChartType         = 'Column'
$script:AutoChart02.Series["Processes Per Host"].Color             = 'Blue'
        
        function Generate-ProcessesAutoChart02 {
            $script:AutoChart02CsvFileHosts     = ($script:AutoChartDataSourceProcesses).PSComputerName | Sort-Object -Unique
            $script:AutoChart02UniqueDataFields = ($script:AutoChartDataSourceProcesses).ProcessID | Sort-Object
            ...
            if ($script:AutoChart02UniqueDataFields.count -gt 0){
                ...
                $script:AutoChart02OverallDataResults | Sort-Object -Property UniqueCount | Select-Object -skip $script:AutoChart02TrimOffFirstTrackBarValue | Select-Object -SkipLast $script:AutoChart02TrimOffLastTrackBarValue | ForEach-Object {$script:AutoChart02.Series["Processes Per Host"].Points.AddXY($_.Computer,$_.ResultsCount)}
...
$script:AutoChart02OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart02.Location.X + 5
                   Y = $script:AutoChart02.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart02ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart02.Size.Height - 125 }
...
$script:AutoChart023DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart02ChartTypeComboBox.Location.X + $script:AutoChart02ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart02 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart02ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Name' -eq $($script:AutoChart02InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart02CheckDiffButton.Add_Click({
    $script:AutoChart02InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
$script:AutoChart02Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:AutoChart03.Series["Process Company"].Color             = 'Green'
        ...
        function Generate-ProcessesAutoChart03 {
            $script:AutoChart03CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart03UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Company' | Sort-Object -Property 'Company' -Unique
...
$script:AutoChart03OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart03.Location.X + 5
                   Y = $script:AutoChart03.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart03ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart03.Size.Height - 125 }
...
$script:AutoChart033DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart03ChartTypeComboBox.Location.X + $script:AutoChart03ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart03 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart03ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Company' -eq $($script:AutoChart03InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart03CheckDiffButton.Add_Click({
    $script:AutoChart03InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Company' -ExpandProperty 'Company' | Sort-Object -Unique
...
$script:AutoChart03Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:AutoChart04.Series["Process Product"].Color             = 'Orange'
        ...
        function Generate-ProcessesAutoChart04 {
            $script:AutoChart04CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart04UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Product' | Sort-Object -Property 'Product' -Unique
...
$script:AutoChart04OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart04.Location.X + 5
                   Y = $script:AutoChart04.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart04ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart04.Size.Height - 125 }
...
$script:AutoChart043DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart04ChartTypeComboBox.Location.X + $script:AutoChart04ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart04 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart04ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Product' -eq $($script:AutoChart04InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart04CheckDiffButton.Add_Click({
    $script:AutoChart04InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Product' -ExpandProperty 'Product' | Sort-Object -Unique
...
$script:AutoChart04Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
### Auto Create Charts Data Series Recent
$script:AutoChart05.Series.Add("Processes with Network Connections")  
$script:AutoChart05.Series["Processes with Network Connections"].Enabled           = $True
$script:AutoChart05.Series["Processes with Network Connections"].BorderWidth       = 1
$script:AutoChart05.Series["Processes with Network Connections"].IsVisibleInLegend = $false
$script:AutoChart05.Series["Processes with Network Connections"].Chartarea         = 'Chart Area'
$script:AutoChart05.Series["Processes with Network Connections"].Legend            = 'Legend'
$script:AutoChart05.Series["Processes with Network Connections"].Font              = New-Object System.Drawing.Font @('Microsoft Sans Serif','9', [System.Drawing.FontStyle]::Normal)
$script:AutoChart05.Series["Processes with Network Connections"]['PieLineColor']   = 'Black'
$script:AutoChart05.Series["Processes with Network Connections"]['PieLabelStyle']  = 'Outside'
$script:AutoChart05.Series["Processes with Network Connections"].ChartType         = 'Column'
$script:AutoChart05.Series["Processes with Network Connections"].Color             = 'Brown'

        function Generate-ProcessesAutoChart05 {
            $script:AutoChart05CsvFileHosts       = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart05UniqueDataFields   = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            $script:AutoChart05.Series["Processes with Network Connections"].Points.Clear()

            if ($script:AutoChart05NetworkConnections.count -gt 0){
                $script:AutoChart05Title.ForeColor = 'Black'
                $script:AutoChart05Title.Text = "Processes with Network Connections"
                ...
                foreach ($DataField in $script:AutoChart05UniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceProcesses ) {
                        if ($Line.Name -eq $DataField.Name -and $Line.NetworkConnections) {
                            $Count += 1
                ...
                $script:AutoChart05Title.Text = "Processes with Network Connections`n
[ No data not available ]`n
...
$script:AutoChart05OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart05.Location.X + 5
                   Y = $script:AutoChart05.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart05ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart05.Size.Height - 125 }
...
$script:AutoChart05ChartTypeComboBox.add_SelectedIndexChanged({
    $script:AutoChart05.Series["Processes with Network Connections"].ChartType = $script:AutoChart05ChartTypeComboBox.SelectedItem
#    $script:AutoChart05.Series["Processes with Network Connections"].Points.Clear()
#    $script:AutoChart05OverallDataResults | Sort-Object -Property UniqueCount | Select-Object -skip $script:AutoChart05TrimOffFirstTrackBarValue | Select-Object -SkipLast $script:AutoChart05TrimOffLastTrackBarValue | ForEach-Object {$script:AutoChart05.Series["Processes with Network Connections"].Points.AddXY($_.DataField.Name,$_.UniqueCount)}
})
...
$script:AutoChart053DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart05ChartTypeComboBox.Location.X + $script:AutoChart05ChartTypeComboBox.Size.Width + 10
...
$script:AutoChart05ChangeColorComboBox.add_SelectedIndexChanged({
    $script:AutoChart05.Series["Processes with Network Connections"].Color = $script:AutoChart05ChangeColorComboBox.SelectedItem
})
...
function script:InvestigateDifference-AutoChart05 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart05ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Name' -eq $($script:AutoChart05InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart05ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart05CheckDiffButton.Add_Click({
    $script:AutoChart05InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
$script:AutoChart05Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:AutoChart06.Series["Process MD5 Hash"].Color             = 'Gray'
        ...
        function Generate-ProcessesAutoChart06 {
            $script:AutoChart06CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart06UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'MD5Hash' | Sort-Object -Property 'MD5Hash' -Unique
...
$script:AutoChart06OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart06.Location.X + 5
                   Y = $script:AutoChart06.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart06ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart06.Size.Height - 125 }
...
$script:AutoChart063DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart06ChartTypeComboBox.Location.X + $script:AutoChart06ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart06 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart06ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'MD5Hash' -eq $($script:AutoChart06InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart06ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart06CheckDiffButton.Add_Click({
    $script:AutoChart06InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'MD5Hash' -ExpandProperty 'MD5Hash' | Sort-Object -Unique
...
$script:AutoChart06Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:AutoChart07.Series["Signer Certificate"].Color             = 'SlateBLue'
        ...
        function Generate-ProcessesAutoChart07 {
            $script:AutoChart07CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart07UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'SignerCertificate' | Sort-Object -Property 'SignerCertificate' -Unique
...
$script:AutoChart07OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart07.Location.X + 5
                   Y = $script:AutoChart07.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart07ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart07.Size.Height - 125 }
...
$script:AutoChart07TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:AutoChart07TrimOffFirstGroupBox.Location.X + $script:AutoChart07TrimOffFirstGroupBox.Size.Width + 10
...
$script:AutoChart073DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart07ChartTypeComboBox.Location.X + $script:AutoChart07ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart07 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart07ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'SignerCertificate' -eq $($script:AutoChart07InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart07ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart07CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart07TrimOffLastGroupBox.Location.X + $script:AutoChart07TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:AutoChart07TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:AutoChart07CheckDiffButton.Add_Click({
    $script:AutoChart07InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'SignerCertificate' -ExpandProperty 'SignerCertificate' | Sort-Object -Unique
...
$script:AutoChart07Results = New-Object Windows.Forms.Button -Property @{
    Text      = "View Results"
...
$script:AutoChart07Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
$script:AutoChart07ManipulationPanel.controls.Add($script:AutoChart07Results)

### Save the chart to file
$script:AutoChart07SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:AutoChart07Results.Location.X
                  Y = $script:AutoChart07Results.Location.Y + $script:AutoChart07Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:AutoChart07SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:AutoChart07.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:AutoChart07NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:AutoChart07SaveButton.Location.X 
                        Y = $script:AutoChart07SaveButton.Location.Y + $script:AutoChart07SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:AutoChart08.Series["Signer Company"].Color             = 'Purple'
        ...
        function Generate-ProcessesAutoChart08 {
            $script:AutoChart08CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart08UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'SignerCompany' | Sort-Object -Property 'SignerCompany' -Unique
...
$script:AutoChart08OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart08.Location.X + 5
                   Y = $script:AutoChart08.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart08ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart08.Size.Height - 125 }
...
$script:AutoChart08TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:AutoChart08TrimOffFirstGroupBox.Location.X + $script:AutoChart08TrimOffFirstGroupBox.Size.Width + 10
...
$script:AutoChart083DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart08ChartTypeComboBox.Location.X + $script:AutoChart08ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart08 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart08ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'SignerCompany' -eq $($script:AutoChart08InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart08ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart08CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart08TrimOffLastGroupBox.Location.X + $script:AutoChart08TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:AutoChart08TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:AutoChart08CheckDiffButton.Add_Click({
    $script:AutoChart08InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'SignerCompany' -ExpandProperty 'SignerCompany' | Sort-Object -Unique
...
$script:AutoChart08Results = New-Object Windows.Forms.Button -Property @{
    Text      = "View Results"
...
$script:AutoChart08Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
$script:AutoChart08ManipulationPanel.controls.Add($script:AutoChart08Results)

### Save the chart to file
$script:AutoChart08SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:AutoChart08Results.Location.X
                  Y = $script:AutoChart08Results.Location.Y + $script:AutoChart08Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:AutoChart08SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:AutoChart08.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:AutoChart08NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:AutoChart08SaveButton.Location.X 
                        Y = $script:AutoChart08SaveButton.Location.Y + $script:AutoChart08SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:AutoChart09.Series["Process Path"].Color             = 'Yellow'
        ...
        function Generate-ProcessesAutoChart09 {
            $script:AutoChart09CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart09UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Path' | Sort-Object -Property 'Path' -Unique
...
$script:AutoChart09OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart09.Location.X + 5
                   Y = $script:AutoChart09.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart09ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart09.Size.Height - 125 }
...
$script:AutoChart09TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:AutoChart09TrimOffFirstGroupBox.Location.X + $script:AutoChart09TrimOffFirstGroupBox.Size.Width + 10
...
$script:AutoChart093DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart09ChartTypeComboBox.Location.X + $script:AutoChart09ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart09 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart09ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'Path' -eq $($script:AutoChart09InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart09ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart09CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart09TrimOffLastGroupBox.Location.X + $script:AutoChart09TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:AutoChart09TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:AutoChart09CheckDiffButton.Add_Click({
    $script:AutoChart09InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'Path' -ExpandProperty 'Path' | Sort-Object -Unique
...
$script:AutoChart09Results = New-Object Windows.Forms.Button -Property @{
    Text      = "View Results"
...
$script:AutoChart09Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
$script:AutoChart09ManipulationPanel.controls.Add($script:AutoChart09Results)

### Save the chart to file
$script:AutoChart09SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:AutoChart09Results.Location.X
                  Y = $script:AutoChart09Results.Location.Y + $script:AutoChart09Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:AutoChart09SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:AutoChart09.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:AutoChart09NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:AutoChart09SaveButton.Location.X 
                        Y = $script:AutoChart09SaveButton.Location.Y + $script:AutoChart09SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:AutoChart10.Series["Services Started By Processes"].Color             = 'Red'
        ...
        function Generate-ProcessesAutoChart10 {
            $script:AutoChart10CsvFileHosts      = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart10UniqueDataFields  = $script:AutoChartDataSourceProcesses | Select-Object -Property 'ServiceInfo' | Sort-Object -Property 'ServiceInfo' -Unique
...
$script:AutoChart10OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart10.Location.X + 5
                   Y = $script:AutoChart10.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:AutoChart10ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:AutoChart10.Size.Height - 125 }
...
$script:AutoChart10TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:AutoChart10TrimOffFirstGroupBox.Location.X + $script:AutoChart10TrimOffFirstGroupBox.Size.Width + 10
...
$script:AutoChart103DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:AutoChart10ChartTypeComboBox.Location.X + $script:AutoChart10ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart10 {    
    # List of Positive Endpoints that positively match
    $script:AutoChart10ImportCsvPosResults = $script:AutoChartDataSourceProcesses | Where-Object 'ServiceInfo' -eq $($script:AutoChart10InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart10ImportCsvAll = $script:AutoChartDataSourceProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:AutoChart10CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:AutoChart10TrimOffLastGroupBox.Location.X + $script:AutoChart10TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:AutoChart10TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:AutoChart10CheckDiffButton.Add_Click({
    $script:AutoChart10InvestDiffDropDownArray = $script:AutoChartDataSourceProcesses | Select-Object -Property 'ServiceInfo' -ExpandProperty 'ServiceInfo' | Sort-Object -Unique
...
$script:AutoChart10Results = New-Object Windows.Forms.Button -Property @{
    Text      = "View Results"
...
$script:AutoChart10Results.Add_Click({ $script:AutoChartDataSourceProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollectionProcesses" }) 
$script:AutoChart10ManipulationPanel.controls.Add($script:AutoChart10Results)

### Save the chart to file
$script:AutoChart10SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:AutoChart10Results.Location.X
                  Y = $script:AutoChart10Results.Location.Y + $script:AutoChart10Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:AutoChart10SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:AutoChart10.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:AutoChart10NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:AutoChart10SaveButton.Location.X 
                        Y = $script:AutoChart10SaveButton.Location.Y + $script:AutoChart10SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
