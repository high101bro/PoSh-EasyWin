    ...
    function PortScan {
        ...
        foreach ($Port in $PortsToScan) {
            ...
            if ($socket.Connected) {
                ...
                $socket.Dispose()
                $socket = $null
                Create-LogEntry -LogFile $LogFile -NoTargetComputer -Message "[Response Time: $contime ms] $IPAddress responded on port $Port"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYX4otTzu9lzIz/heq+qlXuxQ
# gymgggM6MIIDNjCCAh6gAwIBAgIQeugH5LewQKBKT6dPXhQ7sDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUkVlPxIPh1pWTYld0bF6cAuyPTE4wDQYJKoZI
# hvcNAQEBBQAEggEAamdiIpMdzQSDWeAmqtyXhX7jzsgXfE4aDtBWTgdiZSvbGWQw
# ztcrpOtQDB9vQs57ggAmr1S10ZAQMKgcffpFppOzprqXA7CM31gnvQcdGAlrZndw
# AzOnnJ5RZsrH7+Ohv0SZKN4cRO221GdZd7HtNKEGIIEysySRd9xjGq63DSqKDhYr
# ptzo+JLzetgm/syV03hoKwEVLj/Qaj3V3wY3C+FJlE9tYpE1SDHugTBiYrIZ3ltf
# OcluUiB/6c3l/dH6+Qe8fq+hb2IZujF2FIEdA2XQL2nyztNbS3gV1LeBCkmprl4T
# F3d2wcBOVnz8CcUAtWgwkiwLvRRUI0aMWakUpw==
