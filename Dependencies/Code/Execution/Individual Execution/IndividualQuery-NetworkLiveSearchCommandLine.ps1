...
if ($script:CommandTreeViewQueryMethodSelectionComboBox.SelectedItem -eq 'Monitor Jobs') {
    Monitor-Jobs -CollectionName $CollectionName -MonitorMode -SMITH -SmithScript ${function:MonitorJobScriptBlock} -ArgumentList @($ExecutionStartTime,$CollectionName,$NetworkLiveSearchCommandLine,$NetworkLiveRegex) -SmithFlag 'RetrieveFile' -InputValues $InputValues
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUf82va6+WRTei1MCBClRrlBut
# QuqgggM6MIIDNjCCAh6gAwIBAgIQVnYuiASKXo9Gly5kJ70InDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUbsMVTeAe645vTckdd/tSz9u6YnYwDQYJKoZI
# hvcNAQEBBQAEggEAxLECdg6OTU19k0pGt9v+D/jBe2O03BkEbmh5vk133BCVOJpC
# x0/g8tGps3pUUMctOcIEtrgdqL5XEGP87rSEfLnH39QVV17nGgE4rwYnjixCrqKa
# Jw9DZriJYFy+X2oeqZ0mzjFTNk6vR+X9nWwzmBIykUHiBwr+BzbsP4ZQT4+CCLoi
# l7XtQ+y284Z0SoQBFSE7p209+GOSiyzmetqhzXchVPkGYAsNxEvUALcd7ZhXkRNF
# 9D7eb1QvSH5gEJz4iCEPCHJylbeiaDrPDvCYlJn36ItLx7hqID6gRqNpVyUYN/zb
# UKZPoNFroVCncJoixRLIMipfpN7brXBRHUFnew==
