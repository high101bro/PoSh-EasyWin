...
function MonitorJobScriptBlock {
    ...
    foreach ($TargetComputer in $script:ComputerList) {
        ...
        if ($script:ComputerListProvideCredentialsCheckBox.Checked) {
            ...
            -ArgumentList @($NetworkSysmonSearchDestinationIPAddress,$null,$null,$null,$null,$null,$NetworkSysmonRegex) `
...
Invoke-Command -ScriptBlock ${function:MonitorJobScriptBlock} -ArgumentList @($ExecutionStartTime,$CollectionName,$NetworkSysmonSearchDestinationIPAddress,$NetworkSysmonRegex)
...
if ($script:CommandTreeViewQueryMethodSelectionComboBox.SelectedItem -eq 'Monitor Jobs') {
    Monitor-Jobs -CollectionName $CollectionName -MonitorMode -SMITH -SmithScript ${function:MonitorJobScriptBlock} -ArgumentList @($ExecutionStartTime,$CollectionName,$NetworkSysmonSearchDestinationIPAddress,$NetworkSysmonRegex) -InputValues $InputValues
}
