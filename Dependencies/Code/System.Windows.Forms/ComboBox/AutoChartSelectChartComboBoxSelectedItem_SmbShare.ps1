...
$AutoChartPullNewDataButton.Add_Click({
    ...
    if ($AutoChartPullNewDataFromChartsRadioButton.checked){
        ...
        if ($ChartComputerList.count -eq 0) {
            ...
            $ScriptBlockProgressBarInput = { Update-AutoChartsSmbShare -ComputerNameList $ChartComputerList }
    ...
    if ($AutoChartPullNewDataCheckBoxedRadioButton.checked) {
        ...
        if ($script:ComputerList.count -eq 0) {
            ...
            $ScriptBlockProgressBarInput = { Update-AutoChartsSmbShare -ComputerNameList $script:ComputerList }
            Launch-ProgressBarForm -FormTitle 'Progress Bar' -ScriptBlockProgressBarInput $ScriptBlockProgressBarInput
        }
    }
...
CommonButtonSettings -Button $script:AutoChart01SmbShareCheckDiffButton
$script:AutoChart01SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart01SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart01SmbShareSaveButton
...
CommonButtonSettings -Button $script:AutoChart02SmbShare3DToggleButton
...
CommonButtonSettings -Button $script:AutoChart02SmbShareCheckDiffButton
$script:AutoChart02SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart02SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart02SmbShareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
CommonButtonSettings -Button $script:AutoChart03SmbShare3DToggleButton
...
CommonButtonSettings -Button $script:AutoChart03SmbShareCheckDiffButton
$script:AutoChart03SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart03SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Path' -ExpandProperty 'Path' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart03SmbShareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
CommonButtonSettings -Button $script:AutoChart04SmbShare3DToggleButton
...
CommonButtonSettings -Button $script:AutoChart04SmbShareCheckDiffButton
$script:AutoChart04SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart04SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'CurrentUsers' -ExpandProperty 'CurrentUsers' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart04SmbShareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
CommonButtonSettings -Button $script:AutoChart05SmbShare3DToggleButton
...
CommonButtonSettings -Button $script:AutoChart05SmbShareCheckDiffButton
$script:AutoChart05SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart05SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart05SmbShareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
CommonButtonSettings -Button $script:AutoChart06SmbShare3DToggleButton
...
CommonButtonSettings -Button $script:AutoChart06SmbShareCheckDiffButton
$script:AutoChart06SmbShareCheckDiffButton.Add_Click({
    $script:AutoChart06SmbShareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
CommonButtonSettings -Button $script:AutoChart06SmbShareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
