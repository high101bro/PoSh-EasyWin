...
$AutoChartPullNewDataButton.Add_Click({
    ...
    if ($AutoChartPullNewDataFromChartsRadioButton.checked){
        ...
        if ($ChartComputerList.count -eq 0) {
            ...
            $ScriptBlockProgressBarInput = { Update-AutoChartsSoftware -ComputerNameList $ChartComputerList }
    ...
    if ($AutoChartPullNewDataCheckBoxedRadioButton.checked) {
        ...
        if ($script:ComputerList.count -eq 0) {
            ...
            $ScriptBlockProgressBarInput = { Update-AutoChartsSoftware -ComputerNameList $script:ComputerList }
            Launch-ProgressBarForm -FormTitle 'Progress Bar' -ScriptBlockProgressBarInput $ScriptBlockProgressBarInput
        }
    }
...
$script:AutoChart01Software.Series["Software Names"].Color             = 'Red'
        ...
        function Generate-AutoChart01 {
            $script:AutoChart01SoftwareCsvFileHosts      = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart01SoftwareUniqueDataFields  = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
                ...
                foreach ($DataField in $script:AutoChart01SoftwareUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsv ) {
                        if ($($Line.Name) -eq $DataField.Name) {
                            $Count += 1
                            if ( $script:AutoChart01SoftwareCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart01SoftwareCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
CommonButtonSettings -Button $script:AutoChart01SoftwareOptionsButton
...
CommonButtonSettings -Button $script:AutoChart01Software3DToggleButton
...
function script:InvestigateDifference-AutoChart01 {
    ...
    $script:AutoChart01SoftwareImportCsvPosResults = $script:AutoChartDataSourceCsv | Where-Object 'Name' -eq $($script:AutoChart01SoftwareInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    $script:AutoChart01SoftwareImportCsvAll = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
...
CommonButtonSettings -Button $script:AutoChart01SoftwareCheckDiffButton
$script:AutoChart01SoftwareCheckDiffButton.Add_Click({
    $script:AutoChart01SoftwareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    CommonButtonSettings -Button $script:AutoChart01SoftwareInvestDiffExecuteButton
...
$AutoChart01ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvFileName -QueryName "Software" -QueryTabName "Software Names" -PropertyX "Name" -PropertyY "ComputerName" }
}
...
CommonButtonSettings -Button $script:AutoChart01SoftwareOpenInShell
...
CommonButtonSettings -Button $script:AutoChart01SoftwareViewResults
$script:AutoChart01SoftwareViewResults.Add_Click({ $script:AutoChartDataSourceCsv | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
CommonButtonSettings -Button $script:AutoChart01SoftwareSaveButton
...
$script:AutoChart02Software.Series["Software Count Per Host"].Color             = 'Blue'
        ...
        function Generate-AutoChart02 {
            $script:AutoChart02SoftwareCsvFileHosts     = ($script:AutoChartDataSourceCsv).ComputerName | Sort-Object -Unique
            $script:AutoChart02SoftwareUniqueDataFields = ($script:AutoChartDataSourceCsv).Name | Sort-Object -Property 'Name'
...
CommonButtonSettings -Button $script:AutoChart02SoftwareOptionsButton
...
CommonButtonSettings -Button $script:AutoChart02Software3DToggleButton
...
function script:InvestigateDifference-AutoChart02 {
    # List of Positive Endpoints that positively match
    $script:AutoChart02SoftwareImportCsvPosResults = $script:AutoChartDataSourceCsv | Where-Object 'Name' -eq $($script:AutoChart02SoftwareInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02SoftwareImportCsvAll = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
...
CommonButtonSettings -Button $script:AutoChart02SoftwareCheckDiffButton
$script:AutoChart02SoftwareCheckDiffButton.Add_Click({
    $script:AutoChart02SoftwareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    CommonButtonSettings -Button $script:AutoChart02SoftwareInvestDiffExecuteButton
...
$AutoChart02ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvFileName -QueryName "Software" -QueryTabName "Software Count Per Host" -PropertyX "ComputerName" -PropertyY "Name" }
}
...
CommonButtonSettings -Button $script:AutoChart02SoftwareOpenInShell
...
CommonButtonSettings -Button $script:AutoChart02SoftwareViewResults
$script:AutoChart02SoftwareViewResults.Add_Click({ $script:AutoChartDataSourceCsv | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
CommonButtonSettings -Button $script:AutoChart02SoftwareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart03Software.Series["Software Vendor"].Color             = 'Green'
        ...
        function Generate-AutoChart03 {
            $script:AutoChart03SoftwareCsvFileHosts      = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart03SoftwareUniqueDataFields  = $script:AutoChartDataSourceCsv | Select-Object -Property 'Vendor' | Sort-Object -Property 'Vendor' -Unique
                ...
                foreach ($DataField in $script:AutoChart03SoftwareUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsv ) {
                        if ($Line.Vendor -eq $DataField.Vendor) {
                            $Count += 1
                            if ( $script:AutoChart03SoftwareCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart03SoftwareCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
CommonButtonSettings -Button $script:AutoChart03SoftwareOptionsButton
...
CommonButtonSettings -Button $script:AutoChart03Software3DToggleButton
...
function script:InvestigateDifference-AutoChart03 {
    # List of Positive Endpoints that positively match
    $script:AutoChart03SoftwareImportCsvPosResults = $script:AutoChartDataSourceCsv | Where-Object 'Vendor' -eq $($script:AutoChart03SoftwareInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03SoftwareImportCsvAll = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
...
CommonButtonSettings -Button $script:AutoChart03SoftwareCheckDiffButton
$script:AutoChart03SoftwareCheckDiffButton.Add_Click({
    $script:AutoChart03SoftwareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'Vendor' -ExpandProperty 'Vendor' | Sort-Object -Unique
    ...
    CommonButtonSettings -Button $script:AutoChart03SoftwareInvestDiffExecuteButton
...
$AutoChart03ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvFileName -QueryName "Software" -QueryTabName "Software Vendor" -PropertyX "Vendor" -PropertyY "ComputerName" }
}
...
CommonButtonSettings -Button $script:AutoChart03SoftwareOpenInShell
...
CommonButtonSettings -Button $script:AutoChart03SoftwareViewResults
$script:AutoChart03SoftwareViewResults.Add_Click({ $script:AutoChartDataSourceCsv | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
CommonButtonSettings -Button $script:AutoChart03SoftwareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart04Software.Series["Install Dates"].Color             = 'Orange'
        ...
        function Generate-AutoChart04 {
            $script:AutoChart04SoftwareCsvFileHosts      = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart04SoftwareUniqueDataFields  = $script:AutoChartDataSourceCsv | Select-Object -Property 'InstallDate' | Sort-Object -Property 'InstallDate' -Unique
                ...
                foreach ($DataField in $script:AutoChart04SoftwareUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsv ) {
                        if ($($Line.InstallDate) -eq $DataField.InstallDate) {
                            $Count += 1
                            if ( $script:AutoChart04SoftwareCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart04SoftwareCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
CommonButtonSettings -Button $script:AutoChart04SoftwareOptionsButton
...
CommonButtonSettings -Button $script:AutoChart04Software3DToggleButton
...
function script:InvestigateDifference-AutoChart04 {
    # List of Positive Endpoints that positively match
    $script:AutoChart04SoftwareImportCsvPosResults = $script:AutoChartDataSourceCsv | Where-Object 'InstallDate' -eq $($script:AutoChart04SoftwareInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04SoftwareImportCsvAll = $script:AutoChartDataSourceCsv | Select-Object -ExpandProperty 'ComputerName' -Unique
...
CommonButtonSettings -Button $script:AutoChart04SoftwareCheckDiffButton
$script:AutoChart04SoftwareCheckDiffButton.Add_Click({
    $script:AutoChart04SoftwareInvestDiffDropDownArraY = $script:AutoChartDataSourceCsv | Select-Object -Property 'InstallDate' -ExpandProperty 'InstallDate' | Sort-Object -Unique
    ...
    CommonButtonSettings -Button $script:AutoChart04SoftwareInvestDiffExecuteButton
...
$AutoChart04ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvFileName -QueryName "Software" -QueryTabName "Install Dates" -PropertyX "InstallDate" -PropertyY "ComputerName" }
}
...
CommonButtonSettings -Button $script:AutoChart04SoftwareOpenInShell
...
CommonButtonSettings -Button $script:AutoChart04SoftwareViewResults
$script:AutoChart04SoftwareViewResults.Add_Click({ $script:AutoChartDataSourceCsv | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
CommonButtonSettings -Button $script:AutoChart04SoftwareSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
