...
$script:AutoChartDataSourceCsvStartupsStartups = $null
$script:AutoChartDataSourceCsvStartupsStartups = Import-Csv $script:AutoChartCSVFileMostRecentCollection
...
$script:AutoChart01Startups.Series["Startup Names"].Color             = 'Red'
        ...
        function Generate-AutoChart01Startups {
            $script:AutoChart01StartupsCsvFileHosts      = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart01StartupsUniqueDataFields  = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart01StartupsUniqueDataFields.count -gt 0){
                ...
                foreach ($DataField in $script:AutoChart01StartupsUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvStartupsStartups ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart01StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart01Startups {
    ...
    $script:AutoChart01StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'Name' -eq $($script:AutoChart01StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    $script:AutoChart01StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart01StartupsCheckDiffButton
$script:AutoChart01StartupsCheckDiffButton.Add_Click({
    $script:AutoChart01StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart01StartupsInvestDiffExecuteButton
...
$AutoChart01StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "Startup Names" -PropertyX "Name" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart01StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart01StartupsViewResults
$script:AutoChart01StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart01StartupsSaveButton
...
$script:AutoChart02Startups.Series["Startups Per Host"].Color             = 'Blue'
        ...
        function Generate-AutoChart02Startups {
            $script:AutoChart02StartupsCsvFileHosts     = ($script:AutoChartDataSourceCsvStartupsStartups).PSComputerName | Sort-Object -Unique
            $script:AutoChart02StartupsUniqueDataFields = ($script:AutoChartDataSourceCsvStartupsStartups).Name | Sort-Object -Property 'Name'
            ...
            if ($script:AutoChart02StartupsUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvStartupsStartups | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart02StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart02Startups {
    # List of Positive Endpoints that positively match
    $script:AutoChart02StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'Name' -eq $($script:AutoChart02StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart02StartupsCheckDiffButton
$script:AutoChart02StartupsCheckDiffButton.Add_Click({
    $script:AutoChart02StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart02StartupsInvestDiffExecuteButton
...
$AutoChart02StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "Startups per Endpoint" -PropertyX "PSComputerName" -PropertyY "Name" }
}
Apply-CommonButtonSettings -Button $AutoChart02StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart02StartupsViewResults
$script:AutoChart02StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart02StartupsSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart03Startups.Series["Paths"].Color             = 'Green'
        ...
        function Generate-AutoChart03Startups {
            $script:AutoChart03StartupsCsvFileHosts      = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart03StartupsUniqueDataFields  = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Path' | Sort-Object -Property 'Path' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart03StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart03Startups {
    # List of Positive Endpoints that positively match
    $script:AutoChart03StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'Path' -eq $($script:AutoChart03StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart03StartupsCheckDiffButton
$script:AutoChart03StartupsCheckDiffButton.Add_Click({
    $script:AutoChart03StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Path' -ExpandProperty 'Path' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart03StartupsInvestDiffExecuteButton
...
$AutoChart03StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "Paths" -PropertyX "Path" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart03StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart03StartupsViewResults
$script:AutoChart03StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart03StartupsSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart04Startups.Series["Location"].Color             = 'Orange'
        ...
        function Generate-AutoChart04Startups {
            $script:AutoChart04StartupsCsvFileHosts      = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart04StartupsUniqueDataFields  = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Location' | Sort-Object -Property 'Location' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart04Startups {
    # List of Positive Endpoints that positively match
    $script:AutoChart04StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'Location' -eq $($script:AutoChart04StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04StartupsCheckDiffButton
$script:AutoChart04StartupsCheckDiffButton.Add_Click({
    $script:AutoChart04StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Location' -ExpandProperty 'Location' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart04StartupsInvestDiffExecuteButton
...
$AutoChart04StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "Location" -PropertyX "Location" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart04StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart04StartupsViewResults
$script:AutoChart04StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart04StartupsSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
function Generate-AutoChart05Startups {
    $script:AutoChart05StartupsCsvFileHosts      = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
    $script:AutoChart05StartupsUniqueDataFields  = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Command' | Sort-Object -Property 'Command' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart05StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart05Startups {
    # List of Positive Endpoints that positively match
    $script:AutoChart05StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'Name' -eq $($script:AutoChart05StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart05StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart05StartupsCheckDiffButton
$script:AutoChart05StartupsCheckDiffButton.Add_Click({
    $script:AutoChart05StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart05StartupsInvestDiffExecuteButton
...
$AutoChart05StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "Command" -PropertyX "Command" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart05StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart05StartupsViewResults
$script:AutoChart05StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart05StartupsSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
function Generate-AutoChart06Startups {
    $script:AutoChart06StartupsCsvFileHosts      = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
    $script:AutoChart06StartupsUniqueDataFields  = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'User' | Sort-Object -Property 'User' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart06StartupsOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06Startups3DToggleButton
...
function script:InvestigateDifference-AutoChart06Startups {
    # List of Positive Endpoints that positively match
    $script:AutoChart06StartupsImportCsvPosResults = $script:AutoChartDataSourceCsvStartupsStartups | Where-Object 'User' -eq $($script:AutoChart06StartupsInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart06StartupsImportCsvAll = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart06StartupsCheckDiffButton
$script:AutoChart06StartupsCheckDiffButton.Add_Click({
    $script:AutoChart06StartupsInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvStartupsStartups | Select-Object -Property 'User' -ExpandProperty 'User' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart06StartupsInvestDiffExecuteButton
...
$AutoChart06StartupsExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvStartupsStartupsFileName -QueryName "StartupCommand" -QueryTabName "User" -PropertyX "User" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart06StartupsExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06StartupsOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart06StartupsViewResults
$script:AutoChart06StartupsViewResults.Add_Click({ $script:AutoChartDataSourceCsvStartupsStartups | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart06StartupsSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfswmzuxOoHGAu3RuNqXuRuZY
# ZgugggM6MIIDNjCCAh6gAwIBAgIQVnYuiASKXo9Gly5kJ70InDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUqQJbvKAHFfiAeloUXUlhUbFP2gMwDQYJKoZI
# hvcNAQEBBQAEggEAiRAnyJ9D/ghGnFex3p0sLPGOttYhUiMdD8RkhVONv6JwJHYs
# p3Hu+NkO1IlLaeiisSo9P0hH8rNlTvERzRyrSAdpyc2smaKm0Ub0EtbNcmGwz2I3
# swH9ujW9s21vdtC3gUnJdmqCfoSjVkLsstvyysgamL3y6eDkJO2mtr/fUpFRCRmL
# Ll0beVvY8lsYkfXzJSXQ+SY47bb3qFXzaefcP6lfvZZGsZThCpl3B/XwpIwPA092
# TpYziY+knlHwIEol9zN0+i9/AkyroWfv9TXnVOni3tGqnKeUXC2xcmKhc7C0Z4wM
# tjo3TQE/OHPXtYhgB+xofZ13/lV/LSWObzkQgw==
