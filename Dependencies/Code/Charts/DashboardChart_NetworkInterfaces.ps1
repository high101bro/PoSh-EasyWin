...
$script:AutoChartDataSourceCsvNetworkInterfaces = $null
$script:AutoChartDataSourceCsvNetworkInterfaces = Import-Csv $script:AutoChartCSVFileMostRecentCollection
...
$script:AutoChart01NetworkInterfaces.Series["Interface Alias"].Color             = 'Red'
        ...
        function Generate-AutoChart01NetworkInterfaces {
            $script:AutoChart01NetworkInterfacesCsvFileHosts      = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart01NetworkInterfacesUniqueDataFields  = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'InterfaceAlias' | Sort-Object -Property 'InterfaceAlias' -Unique
            ...
            if ($script:AutoChart01NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ($DataField in $script:AutoChart01NetworkInterfacesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvNetworkInterfaces ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart01NetworkInterfaces {
    ...
    $script:AutoChart01NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesCheckDiffButton
$script:AutoChart01NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart01NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'InterfaceAlias' -ExpandProperty 'InterfaceAlias' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart01NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "Interface Alias" -PropertyX "InterfaceAlias" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart01NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesViewResults
$script:AutoChart01NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart01NetworkInterfacesSaveButton
...
$script:AutoChart02NetworkInterfaces.Series["Interfaces with IPs Per Host"].Color             = 'Blue'
        ...
        function Generate-AutoChart02NetworkInterfaces {
            $script:AutoChart02NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart02NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart02NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart02NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesCheckDiffButton
$script:AutoChart02NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart02NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart02NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "Interfaces with IPs Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart02NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesViewResults
$script:AutoChart02NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart02NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart03NetworkInterfaces.Series["IPv4 Interfaces Per Host"].Color             = 'Green'
        ...
        function Generate-AutoChart03NetworkInterfaces {
            $script:AutoChart03NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart03NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart03NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.AddressFamily -eq 'IPv4'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart03NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesCheckDiffButton
$script:AutoChart03NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart03NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart03NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPv4 Interfaces Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart03NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesViewResults
$script:AutoChart03NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart03NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart04NetworkInterfaces.Series["IPv6 Interfaces Per Host"].Color             = 'orange'
        ...
        function Generate-AutoChart04NetworkInterfaces {
            $script:AutoChart04NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart04NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart04NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.AddressFamily -eq 'IPv6'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart04NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesCheckDiffButton
$script:AutoChart04NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart04NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart04NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPv6 Interfaces Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart04NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesViewResults
$script:AutoChart04NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart04NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart05NetworkInterfaces.Series["IPs (Manual) Per Host"].Color             = 'Brown'
        ...
        function Generate-AutoChart05NetworkInterfaces {
            $script:AutoChart05NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart05NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart05NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.PrefixOrigin -eq 'Manual'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart05NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart05NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesCheckDiffButton
$script:AutoChart05NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart05NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart05NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPs (Manual) Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart05NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesViewResults
$script:AutoChart05NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart05NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart06NetworkInterfaces.Series["IPs (DHCP) Per Host"].Color             = 'Gray'
        ...
        function Generate-AutoChart06NetworkInterfaces {
            $script:AutoChart06NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart06NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart06NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.PrefixOrigin -eq 'DHCP'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart06NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart06NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesCheckDiffButton
$script:AutoChart06NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart06NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart06NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPs (DHCP) Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart06NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesViewResults
$script:AutoChart06NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart06NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart07NetworkInterfaces.Series["IPs (Well Known) Per Host"].Color             = 'SlateBLue'
        ...
        function Generate-AutoChart07NetworkInterfaces {
            $script:AutoChart07NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart07NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart07NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.PrefixOrigin -eq 'WellKnown'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart07NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart07NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesCheckDiffButton
$script:AutoChart07NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart07NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart07NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPs (Well Known) Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart07NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesViewResults
$script:AutoChart07NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart07NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart08NetworkInterfaces.Series["IPs (Router Advertisement) Per Host"].Color             = 'Purple'
        ...
        function Generate-AutoChart08NetworkInterfaces {
            $script:AutoChart08NetworkInterfacesCsvFileHosts     = ($script:AutoChartDataSourceCsvNetworkInterfaces).PSComputerName | Sort-Object -Unique
            $script:AutoChart08NetworkInterfacesUniqueDataFields = ($script:AutoChartDataSourceCsvNetworkInterfaces).IPAddress | Sort-Object -Property 'IPAddress'
            ...
            if ($script:AutoChart08NetworkInterfacesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvNetworkInterfaces | Where-Object {$_.PrefixOrigin -eq 'RouterAdvertisement'} | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart08NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart08NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesCheckDiffButton
$script:AutoChart08NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart08NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart08NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "IPs (Router Advertisement) Per Host" -PropertyX "PSComputerName" -PropertyY "IPAddress" }
}
Apply-CommonButtonSettings -Button $AutoChart08NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesViewResults
$script:AutoChart08NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart08NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart09NetworkInterfaces.Series["Address State"].Color             = 'Yellow'
        ...
        function Generate-AutoChart09NetworkInterfaces {
            $script:AutoChart09NetworkInterfacesCsvFileHosts      = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart09NetworkInterfacesUniqueDataFields  = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'AddressState' | Sort-Object -Property 'AddressState' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart09NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart09NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesCheckDiffButton
$script:AutoChart09NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart09NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'AddressState' -ExpandProperty 'AddressState' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart09NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "Address States" -PropertyX "AddressState" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart09NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesViewResults
$script:AutoChart09NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart09NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart10NetworkInterfaces.Series["Address Family"].Color             = 'Red'
        ...
        function Generate-AutoChart10NetworkInterfaces {
            $script:AutoChart10NetworkInterfacesCsvFileHosts      = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart10NetworkInterfacesUniqueDataFields  = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'AddressFamily' | Sort-Object -Property 'AddressFamily' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfaces3DToggleButton
...
function script:InvestigateDifference-AutoChart10NetworkInterfaces {
    ...
    # List of all endpoints within the csv file
    $script:AutoChart10NetworkInterfacesImportCsvAll = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesCheckDiffButton
$script:AutoChart10NetworkInterfacesCheckDiffButton.Add_Click({
    $script:AutoChart10NetworkInterfacesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvNetworkInterfaces | Select-Object -Property 'AddressFamily' -ExpandProperty 'AddressFamily' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesInvestDiffExecuteButton
...
$AutoChart10NetworkInterfacesExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvNetworkInterfacesFileName -QueryName "Network Settings" -QueryTabName "Address Family" -PropertyX "AddressFamily" -PropertyY "PSComputerName" }
}
Apply-CommonButtonSettings -Button $AutoChart10NetworkInterfacesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesViewResults
$script:AutoChart10NetworkInterfacesViewResults.Add_Click({ $script:AutoChartDataSourceCsvNetworkInterfaces | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart10NetworkInterfacesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDGERQDlDnAGZqou0IjEqqx5l
# AmmgggM6MIIDNjCCAh6gAwIBAgIQVnYuiASKXo9Gly5kJ70InDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU9/PBBjsuKNox4OFo+xVpAw6Cu+UwDQYJKoZI
# hvcNAQEBBQAEggEAXuFRIBWZini0uAtv0eNVS9+u/zFD6rY/HpUGTXGrwx3xJXFz
# 4HhSs/AFIEzZN4+6zZZ1iaYwa1OozNXY7Z78JIt+iVTvY5tGngVAr9Ep7DPjDNRW
# Pk/2WCkHRVlzhVvZwJVQ5FFRF2c8tYCDNIfUfoEt99oOyCfLMic9cGfRzkn05+ij
# FYXkaO+yglMwNDoM72mBEYbsC1wRFnxjIr7mx8x47/sXPynDrfnQHG2D6DWCiydF
# CmWtclGN1vMjw/s3BXCqyP/lMvm+V4f1KIHwvQlYH8sAEw+Z9cn5vF6/MKLVivpH
# R2PDe71MZYkJdR8nB0ZHlE96+QXlB9+lFHL3UA==
