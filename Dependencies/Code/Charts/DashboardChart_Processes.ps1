...
$script:AutoChartDataSourceCsvProcesses = $null
$script:AutoChartDataSourceCsvProcesses = Import-Csv $script:AutoChartCSVFileMostRecentCollection
...
$script:AutoChart01Processes.Series["Unique Processes"].Color             = 'Red'
        ...
        function Generate-AutoChart01 {
            $script:AutoChart01ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart01ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart01ProcessesUniqueDataFields.count -gt 0){
                ...
                foreach ($DataField in $script:AutoChart01ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart01 {
    ...
    $script:AutoChart01ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Name' -eq $($script:AutoChart01ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    $script:AutoChart01ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesCheckDiffButton
$script:AutoChart01ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart01ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesInvestDiffExecuteButton
...
$AutoChart01ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Unique Processes" -PropertyX "Name" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesViewResults
$script:AutoChart01ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart01ProcessesSaveButton
...
$script:AutoChart02Processes.Series["Processes Per Host"].Color             = 'Blue'
        ...
        function Generate-AutoChart02 {
            $script:AutoChart02ProcessesCsvFileHosts     = ($script:AutoChartDataSourceCsvProcesses).PSComputerName | Sort-Object -Unique
            $script:AutoChart02ProcessesUniqueDataFields = ($script:AutoChartDataSourceCsvProcesses).ProcessID | Sort-Object -Property 'ProcessID'
            ...
            if ($script:AutoChart02ProcessesUniqueDataFields.count -gt 0){
                ...
                foreach ( $Line in $($script:AutoChartDataSourceCsvProcesses | Sort-Object PSComputerName) ) {
...
Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart02 {
    # List of Positive Endpoints that positively match
    $script:AutoChart02ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Name' -eq $($script:AutoChart02ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesCheckDiffButton
$script:AutoChart02ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart02ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesInvestDiffExecuteButton
...
$AutoChart02ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Processes per Endpoint" -PropertyX "PSComputerName" -PropertyY "ProcessID" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesViewResults
$script:AutoChart02ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart02ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart03Processes.Series["Process Company"].Color             = 'Green'
        ...
        function Generate-AutoChart03 {
            $script:AutoChart03ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart03ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Company' | Sort-Object -Property 'Company' -Unique
                ...
                foreach ($DataField in $script:AutoChart03ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($Line.Company -eq $DataField.Company) {
                            $Count += 1
                            if ( $script:AutoChart03ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart03ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart03 {
    # List of Positive Endpoints that positively match
    $script:AutoChart03ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Company' -eq $($script:AutoChart03ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesCheckDiffButton
$script:AutoChart03ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart03ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Company' -ExpandProperty 'Company' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesInvestDiffExecuteButton
...
$AutoChart03ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Process Company" -PropertyX "Company" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesViewResults
$script:AutoChart03ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart03ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart04Processes.Series["Process Product"].Color             = 'Orange'
        ...
        function Generate-AutoChart04 {
            $script:AutoChart04ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart04ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Product' | Sort-Object -Property 'Product' -Unique
                ...
                foreach ($DataField in $script:AutoChart04ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.Product) -eq $DataField.Product) {
                            $Count += 1
                            if ( $script:AutoChart04ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart04ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart04 {
    # List of Positive Endpoints that positively match
    $script:AutoChart04ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Product' -eq $($script:AutoChart04ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesCheckDiffButton
$script:AutoChart04ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart04ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Product' -ExpandProperty 'Product' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesInvestDiffExecuteButton
...
$AutoChart04ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Process Product" -PropertyX "Product" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesViewResults
$script:AutoChart04ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart04ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart05Processes.Series["Processes with Network Activity"].Color             = 'Brown'
        ...
        function Generate-AutoChart05 {
            $script:AutoChart05ProcessesCsvFileHosts       = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart05ProcessesUniqueDataFields   = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
                ...
                foreach ($DataField in $script:AutoChart05ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($Line.Name -eq $DataField.Name -and $Line.NetworkConnectionCount -gt 0) {
                            $Count += 1
                            if ( $script:AutoChart05ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart05ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
                    if ($Count -gt 0) {
...
Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart05 {
    # List of Positive Endpoints that positively match
    $script:AutoChart05ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Name' -eq $($script:AutoChart05ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart05ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesCheckDiffButton
$script:AutoChart05ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart05ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesInvestDiffExecuteButton
...
$AutoChart05ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Processes With Network Activity" -PropertyX "NetworkConnections" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesViewResults
$script:AutoChart05ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart05ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart06Processes.Series["Process MD5 Hash"].Color             = 'Gray'
        ...
        function Generate-AutoChart06 {
            $script:AutoChart06ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart06ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'MD5Hash' | Sort-Object -Property 'MD5Hash' -Unique
                ...
                foreach ($DataField in $script:AutoChart06ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.MD5Hash) -eq $DataField.MD5Hash) {
                            $Count += 1
                            if ( $script:AutoChart06ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart06ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart06 {
    # List of Positive Endpoints that positively match
    $script:AutoChart06ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'MD5Hash' -eq $($script:AutoChart06ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart06ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesCheckDiffButton
$script:AutoChart06ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart06ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'MD5Hash' -ExpandProperty 'MD5Hash' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesInvestDiffExecuteButton
...
$AutoChart06ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Process MD5 Hashes" -PropertyX "MD5Hash" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesViewResults
$script:AutoChart06ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart06ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart07Processes.Series["Signer Certificate"].Color             = 'SlateBLue'
        ...
        function Generate-AutoChart07 {
            $script:AutoChart07ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart07ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'SignerCertificate' | Sort-Object -Property 'SignerCertificate' -Unique
                ...
                foreach ($DataField in $script:AutoChart07ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.SignerCertificate) -eq $DataField.SignerCertificate) {
                            $Count += 1
                            if ( $script:AutoChart07ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart07ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart07Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart07 {
    # List of Positive Endpoints that positively match
    $script:AutoChart07ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'SignerCertificate' -eq $($script:AutoChart07ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart07ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesCheckDiffButton
$script:AutoChart07ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart07ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'SignerCertificate' -ExpandProperty 'SignerCertificate' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesInvestDiffExecuteButton
...
$AutoChart07ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Process Signer Certificate" -PropertyX "SignerCertificate" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesViewResults
$script:AutoChart07ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart07ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart08Processes.Series["Signer Company"].Color             = 'Purple'
        ...
        function Generate-AutoChart08 {
            $script:AutoChart08ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart08ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'SignerCompany' | Sort-Object -Property 'SignerCompany' -Unique
                ...
                foreach ($DataField in $script:AutoChart08ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.SignerCompany) -eq $DataField.SignerCompany) {
                            $Count += 1
                            if ( $script:AutoChart08ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart08ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart08Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart08 {
    # List of Positive Endpoints that positively match
    $script:AutoChart08ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'SignerCompany' -eq $($script:AutoChart08ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart08ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesCheckDiffButton
$script:AutoChart08ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart08ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'SignerCompany' -ExpandProperty 'SignerCompany' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesInvestDiffExecuteButton
...
$AutoChart08ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Processes Signer Company" -PropertyX "SignerCompany" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesViewResults
$script:AutoChart08ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart08ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart09Processes.Series["Process Path"].Color             = 'Yellow'
        ...
        function Generate-AutoChart09 {
            $script:AutoChart09ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart09ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Path' | Sort-Object -Property 'Path' -Unique
                ...
                foreach ($DataField in $script:AutoChart09ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.Path) -eq $DataField.Path) {
                            $Count += 1
                            if ( $script:AutoChart09ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart09ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart09Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart09 {
    # List of Positive Endpoints that positively match
    $script:AutoChart09ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'Path' -eq $($script:AutoChart09ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart09ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesCheckDiffButton
$script:AutoChart09ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart09ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'Path' -ExpandProperty 'Path' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesInvestDiffExecuteButton
...
$AutoChart09ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Process Paths" -PropertyX "Path" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesViewResults
$script:AutoChart09ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart09ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart10Processes.Series["Services Started By Processes"].Color             = 'Red'
        ...
        function Generate-AutoChart10 {
            $script:AutoChart10ProcessesCsvFileHosts      = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
            $script:AutoChart10ProcessesUniqueDataFields  = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'ServiceInfo' | Sort-Object -Property 'ServiceInfo' -Unique
                ...
                foreach ($DataField in $script:AutoChart10ProcessesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvProcesses ) {
                        if ($($Line.ServiceInfo) -eq $DataField.ServiceInfo) {
                            $Count += 1
                            if ( $script:AutoChart10ProcessesCsvComputers -notcontains $($Line.PSComputerName) ) { $script:AutoChart10ProcessesCsvComputers += $($Line.PSComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart10Processes3DToggleButton
...
function script:InvestigateDifference-AutoChart10 {
    # List of Positive Endpoints that positively match
    $script:AutoChart10ProcessesImportCsvPosResults = $script:AutoChartDataSourceCsvProcesses | Where-Object 'ServiceInfo' -eq $($script:AutoChart10ProcessesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart10ProcessesImportCsvAll = $script:AutoChartDataSourceCsvProcesses | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesCheckDiffButton
$script:AutoChart10ProcessesCheckDiffButton.Add_Click({
    $script:AutoChart10ProcessesInvestDiffDropDownArray = $script:AutoChartDataSourceCsvProcesses | Select-Object -Property 'ServiceInfo' -ExpandProperty 'ServiceInfo' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesInvestDiffExecuteButton
...
$AutoChart10ExpandChartButton = New-Object System.Windows.Forms.Button -Property @{
    ...
    Size   = @{ Width  = $FormScale * 100
                Height = $FormScale * 23 }
    Add_Click  = { Generate-AutoChartsCommand -FilePath $script:AutoChartDataSourceCsvProcessesFileName -QueryName "Processes" -QueryTabName "Services Started By Processes" -PropertyX "ServiceInfo" -PropertyY "PSComputerName" }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesViewResults
$script:AutoChart10ProcessesViewResults.Add_Click({ $script:AutoChartDataSourceCsvProcesses | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart10ProcessesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHUn5WYPzs3LfMUVvZ7gPovWl
# 2tegggM6MIIDNjCCAh6gAwIBAgIQeugH5LewQKBKT6dPXhQ7sDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUwKVDoJFs1U+DII0pOamjLGakcpQwDQYJKoZI
# hvcNAQEBBQAEggEACaJFLJqRbzvp0K7Tv+5h3xr8B5gaYp1jntuBfARCtjUJLNHe
# Uwh1154a5ykwzFYbvXOYW0XKxhVMDucd9WQkiB09QZoScN1z9uDaoYUisneydkul
# RGNfQMk3DyhRI9vp5kG9eGfNSAqrvURndWKT01FKPF2mFdhdEtebBlgVMKiS1m7D
# jSg2cPwnWXRAY14MhKUhthFza+eAE7VNC4cqoILaRcC5a69UE5TQo1OWzwwxPWDR
# q1NYqpm29TLeFdmlg3nqhJYNBGvntBuIMsH3B/wnqjb9Bk7GJFCmCt8sKLo5Jrr7
# 615xopbLfBsvXBpRqthl9sauKbPfG6/bzTdzyw==
