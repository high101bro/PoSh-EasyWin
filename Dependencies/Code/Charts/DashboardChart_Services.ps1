...
$script:AutoChartDataSourceCsvServices = $null
$script:AutoChartDataSourceCsvServices = Import-Csv $script:AutoChartCSVFileMostRecentCollection
...
$script:AutoChart01Services.Series["Running Services"].Color             = 'Red'
        ...
        function Generate-AutoChart01 ($Filter) {
            $script:AutoChart01ServicesCsvFileHosts     = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart01ServicesUniqueDataFields = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq "$Filter" -or $_.Status -eq "$Filter"} | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart01ServicesUniqueDataFields.count -gt 0){
                ...
                $FilteredData = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq "$Filter" -or $_.Status -eq "$Filter"}
                ...
                foreach ($DataField in $script:AutoChart01ServicesUniqueDataFields) {
                    ...
                    foreach ( $Line in $FilteredData ) {
                        if ($Line.Name -eq $DataField.Name) {
                            $Count += 1
                            if ( $script:AutoChart01ServicesCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart01ServicesCsvComputers += $($Line.ComputerName) }
                        }
                    }
                    ### much slower than the above code
                    #$DataMatch = $FilteredData | Where-Object {$_.name -eq $DataField.Name}
                    #$Count = $DataMatch.Count
                    #$script:AutoChart01ServicesCsvComputers = $DataMatch | Select-Object ComputerName -unique
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01Services3DToggleButton
...
function script:InvestigateDifference-AutoChart01 ($Filter) {
    ...
    $script:AutoChart01ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'Name' -eq $($script:AutoChart01ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    $script:AutoChart01ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesCheckDiffButton
$script:AutoChart01ServicesCheckDiffButton.Add_Click({
    $script:AutoChart01ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart01ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesResults
$script:AutoChart01ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart01ServicesSaveButton
...
$script:AutoChart02Services.Series["Running Services Per Host"].Color             = 'Blue'
        ...
        function Generate-AutoChart02 ($Filter) {
            $script:AutoChart02ServicesCsvFileHosts     = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'ComputerName' -ExpandProperty 'ComputerName' | Sort-Object -Unique
            $script:AutoChart02ServicesUniqueDataFields = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq "$Filter" -or $_.Status -eq "$Filter"} | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object  -Unique
            ...
            if ($script:AutoChart02ServicesUniqueDataFields.count -gt 0){
                ...
                $FilteredData = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq "$Filter" -or $_.Status -eq "$Filter"} | Sort-Object ComputerName
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02Services3DToggleButton
...
function script:InvestigateDifference-AutoChart02 {
    # List of Positive Endpoints that positively match
    $script:AutoChart02ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'Name' -eq $($script:AutoChart02ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart02ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesCheckDiffButton
$script:AutoChart02ServicesCheckDiffButton.Add_Click({
    $script:AutoChart02ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart02ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesResults
$script:AutoChart02ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart02ServicesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart03Services.Series["Automatic Startup Services"].Color             = 'Green'
        ...
        function Generate-AutoChart03 ($Filter) {
            $script:AutoChart03ServicesCsvFileHosts      = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart03ServicesUniqueDataFields  = $script:AutoChartDataSourceCsvServices | Where-Object {$_.StartType -match $Filter -or $_.StartMode -match $Filter} | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart03ServicesUniqueDataFields.count -gt 0){
                ...
                $FilteredData = $script:AutoChartDataSourceCsvServices | Where-Object {$_.StartType -match $Filter -or $_.StartMode -match $Filter}
                ...
                foreach ($DataField in $script:AutoChart03ServicesUniqueDataFields) {
                    ...
                    foreach ( $Line in $FilteredData ) {
                        if ($Line.Name -eq $DataField.Name) {
                            $Count += 1
                            if ( $script:AutoChart03ServicesCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart03ServicesCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesOptionsButton
...
#    $script:AutoChart03ServicesOverallDataResults | Sort-Object -Property UniqueCount | Select-Object -skip $script:AutoChart03ServicesTrimOffFirstTrackBarValue | Select-Object -SkipLast $script:AutoChart03ServicesTrimOffLastTrackBarValue | ForEach-Object {$script:AutoChart03Services.Series["Automatic Startup Services"].Points.AddXY($_.DataField.Name,$_.UniqueCount)}
 ...
 $WhichVersionStart = $script:AutoChartDataSourceCsvServices | Where-Object {$_.StartType -match $Filter -or $_.StartMode -match $Filter}
if ($WhichVersionStart.StartType -ne $null) {
    $script:AutoChart03ServicesFilterAvailable = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty StartType -Unique
    if ($script:AutoChart03ServicesFilterAvailable.Count -eq 0){ $script:AutoChartDataSourceCsvServices | Select-Object StartType -Unique | ForEach-Object { if ($script:AutoChart03ServicesFilterAvailable -inotcontains $_.StartType) {$script:AutoChart03ServicesFilterAvailable += $_.StartType}} }
}
else {
    $script:AutoChart03ServicesFilterAvailable = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty StartMode -Unique
    if ($script:AutoChart03ServicesFilterAvailable.Count -eq 0){ $script:AutoChartDataSourceCsvServices | Select-Object StartMode -Unique | ForEach-Object { if ($script:AutoChart03ServicesFilterAvailable -inotcontains $_.StartMode) {$script:AutoChart03ServicesFilterAvailable += $_.StartMode}} }
}
...
Apply-CommonButtonSettings -Button $script:AutoChart03Services3DToggleButton
...
function script:InvestigateDifference-AutoChart03 {
    # List of Positive Endpoints that positively match
    $script:AutoChart03ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'Name' -eq $($script:AutoChart03ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart03ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesCheckDiffButton
$script:AutoChart03ServicesCheckDiffButton.Add_Click({
    $script:AutoChart03ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart03ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesResults
$script:AutoChart03ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart03ServicesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart04Services.Series["Services Started By LocalSystem"].Color             = 'Orange'
        ...
        function Generate-AutoChart04 ($Filter) {
            $script:AutoChart04ServicesCsvFileHosts      = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart04ServicesUniqueDataFields  = $script:AutoChartDataSourceCsvServices | Where-Object {$_.StartName -eq "$Filter"} | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:AutoChart04ServicesUniqueDataFields.count -gt 0){
                ...
                $FilteredData = $script:AutoChartDataSourceCsvServices | Where-Object {$_.StartName -eq "$Filter"}
                ...
                foreach ($DataField in $script:AutoChart04ServicesUniqueDataFields) {
                    ...
                    foreach ( $Line in $FilteredData ) {
                        if ($($Line.Name) -eq $DataField.Name) {
                            $Count += 1
                            if ( $script:AutoChart04ServicesCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart04ServicesCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesOptionsButton
...
$script:AutoChart04ServicesFilterAvailable = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty StartName -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04Services3DToggleButton
...
function script:InvestigateDifference-AutoChart04 {
    # List of Positive Endpoints that positively match
    $script:AutoChart04ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'Name' -eq $($script:AutoChart04ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart04ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesCheckDiffButton
$script:AutoChart04ServicesCheckDiffButton.Add_Click({
    $script:AutoChart04ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart04ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesResults
$script:AutoChart04ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart04ServicesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart05Services.Series["Processes That Started Services "].Color             = 'Brown'
        ...
        function Generate-AutoChart05 {
            $script:AutoChart05ServicesCsvFileHosts      = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart05ServicesUniqueDataFields  = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq 'Running' -or $_.Status -eq 'Running'} | Select-Object -Property 'ProcessName' | Sort-Object -Property 'ProcessName' -Unique
            ...
            if ($script:AutoChart05ServicesUniqueDataFields.count -gt 0){
                ...
                $FilteredData = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq 'Running' -or $_.Status -eq 'Running'}
                ...
                foreach ($DataField in $script:AutoChart05ServicesUniqueDataFields) {
                    ...
                    foreach ( $Line in $FilteredData ) {
                        if ($Line.ProcessName -eq $DataField.ProcessName) {
                            $Count += 1
                            if ( $script:AutoChart05ServicesCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart05ServicesCsvComputers += $($Line.ComputerName) }
                        }
                    }
                    if ($Count -gt 0) {
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05Services3DToggleButton
...
function script:InvestigateDifference-AutoChart05 {
    # List of Positive Endpoints that positively match
    $script:AutoChart05ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'ProcessName' -eq $($script:AutoChart05ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart05ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesCheckDiffButton
$script:AutoChart05ServicesCheckDiffButton.Add_Click({
    $script:AutoChart05ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'ProcessName' -ExpandProperty 'ProcessName' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart05ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesResults
$script:AutoChart05ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart05ServicesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
$script:AutoChart06Services.Series["Accounts That Started Services"].Color             = 'Gray'
        ...
        function Generate-AutoChart06 {
            $script:AutoChart06ServicesCsvFileHosts      = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
            $script:AutoChart06ServicesUniqueDataFields  = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'StartName' | Sort-Object -Property 'StartName' -Unique
#            $script:AutoChart05ServicesUniqueDataFields  = $script:AutoChartDataSourceCsvServices | Where-Object {$_.State -eq 'Running' -or $_.Status -eq 'Running'} | Select-Object -Property 'ProcessName' | Sort-Object -Property 'ProcessName' -Unique
            ...
            if ($script:AutoChart06ServicesUniqueDataFields.count -gt 0){
                ...
                foreach ($DataField in $script:AutoChart06ServicesUniqueDataFields) {
                    ...
                    foreach ( $Line in $script:AutoChartDataSourceCsvServices ) {
                        if ($($Line.StartName) -eq $DataField.StartName) {
                            $Count += 1
                            if ( $script:AutoChart06ServicesCsvComputers -notcontains $($Line.ComputerName) ) { $script:AutoChart06ServicesCsvComputers += $($Line.ComputerName) }
                        }
                    }
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesOptionsButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06Services3DToggleButton
...
function script:InvestigateDifference-AutoChart06 {
    # List of Positive Endpoints that positively match
    $script:AutoChart06ServicesImportCsvPosResults = $script:AutoChartDataSourceCsvServices | Where-Object 'StartName' -eq $($script:AutoChart06ServicesInvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'ComputerName' -Unique
    ...
    # List of all endpoints within the csv file
    $script:AutoChart06ServicesImportCsvAll = $script:AutoChartDataSourceCsvServices | Select-Object -ExpandProperty 'ComputerName' -Unique
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesCheckDiffButton
$script:AutoChart06ServicesCheckDiffButton.Add_Click({
    $script:AutoChart06ServicesInvestDiffDropDownArraY = $script:AutoChartDataSourceCsvServices | Select-Object -Property 'StartName' -ExpandProperty 'StartName' | Sort-Object -Unique
    ...
    Apply-CommonButtonSettings -Button $script:AutoChart06ServicesInvestDiffExecuteButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesExpandChartButton
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesOpenInShell
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesResults
$script:AutoChart06ServicesResults.Add_Click({ $script:AutoChartDataSourceCsvServices | Out-GridView -Title "$script:AutoChartCSVFileMostRecentCollection" })
...
Apply-CommonButtonSettings -Button $script:AutoChart06ServicesSaveButton
[enum]::GetNames('System.Windows.Forms.DataVisualization.Charting.ChartImageFormat')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFmVbAdCCLzgdRUBlYzqedKoS
# VHCgggM6MIIDNjCCAh6gAwIBAgIQVnYuiASKXo9Gly5kJ70InDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUmG5UlR2hQh9BF91jfSPYOt95l90wDQYJKoZI
# hvcNAQEBBQAEggEAgFV/IxPc36OHjh74MTET2y+sp8nE+1wVd8vMtJQirx2YB8jg
# t+1J+PYqh6LgacbwEYOODTiqbDSCDjtbin4dQYdcCQTgpO3jAcBU/AKF/PNiPe1c
# oONdRl5yT+9AyF5ovgNrlchF5rsQnoxk2VyUJvbS9f00C83FOdpZBoCNlf01+x68
# 64sABsktWZ7Fbop9CSqYp+2BO2JBZ7R7oEeqo7nMSHmK4Kx2YBjvAQVSYDTlQIpw
# ke8y3zvCOS69YuPcdU6kUQR2J/VcSz6AU6URTB8MyVjHIXwbSCzL5np3GtpLxQ/E
# 7idLKu9jHeV5DNi/goaHHf/7ntckeQ/FrEJVcg==
