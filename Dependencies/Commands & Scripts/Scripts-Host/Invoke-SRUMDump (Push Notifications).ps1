<#
    .SYNOPSIS
        Invoke-SRUMDump (Push Notification) is a pure PowerShell / .Net capability that enables the dumping of the System Resource Utilization Management (SRUM) database for CSVs. The database generally 
...
[CmdletBinding()]
param(
    $ExportDir = "C:\Windows\Temp\srum\push_notifications"
)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURVzSiZ+YnFNHwFtWeE5d7DDP
# II6gggM6MIIDNjCCAh6gAwIBAgIQVnYuiASKXo9Gly5kJ70InDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU8VMToIsCAjlPTIYYxvsslnUZOjQwDQYJKoZI
# hvcNAQEBBQAEggEAyXV2uHpoWG0DytF+jPD9dAnZgHAp4eDuPbE3IVhDbt3ba1dm
# IPHrsYfXXOKqmm8VGQN/m+uTyXwa/ImJnBGMe8u0Smj2FkfGxWc44lEzn2ZzPFSI
# urSKBckQKGPEIbS+7c61OYso1scyP0hdbSk7TJN0lZ46CLLIB2QiPM48xrUQEdI3
# XPWwl4GOtpcwQIU16rckrtH8KZwsuFrk6kyDUlvJFu7wWPmPoj9qXO0D38qWI5cP
# nsnd378YmYCTnEj6Z8av0paqYXMuxVVsRuQDQOi3x6Uua1mIkGGAHpZOwrRIuVea
# kxVzyHnEXAKTKTLwekfHVMP8BlLEEiN617fVpw==
