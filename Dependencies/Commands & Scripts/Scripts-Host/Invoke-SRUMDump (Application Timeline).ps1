<#
    .SYNOPSIS
        Invoke-SRUMDump (Application Timeline) is a pure PowerShell / .Net capability that enables the dumping of the System Resource Utilization Management (SRUM) database for CSVs. The database generally 
...
[CmdletBinding()]
param(
    $ExportDir = "C:\Windows\Temp\srum\application_timeline"
)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/Y15Gmn/dovxEL3El3hVhggc
# FeigggM6MIIDNjCCAh6gAwIBAgIQeugH5LewQKBKT6dPXhQ7sDANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUhABvNI7LhgvmgsiGbO/xnXFsPdcwDQYJKoZI
# hvcNAQEBBQAEggEAU9F2ocu/dzQpucDQitmoX2hEoNqiHpqjVE6U+xdVzLSHdadO
# s2TVYZSSwVWFAiuA8GAjdn57Yqw9Wg1zxvTAv0DPzZT9Bqek1NcZkIDKGhM9mjSe
# Aq5B/piHORQ4W6sds8GdjzVSJZ7y/nAK5LGniGA3w3Yquk+V4dqDYZSlqe4cbSXV
# lrr/r47Ddcyb/kOTDspoI2SVxfU4Lu8t2n5lQJsfozHUh+75Ql0xvlUKqN0Y873O
# DfEwGDSmNcIMM2JY8jrDfIY514E2mj7H0qDa03dMgAjBx6tqMjkkduJp/5/xG/WS
# jkZiup9bLTsanDI+af4wCJqNyFxzAl4BvDEXgQ==
