function Create-RetrievedFileDetails {
    ...
    $RetrievedFileProperties = Invoke-Command -ScriptBlock { param($File) Get-ItemProperty "$($File.FullName)" | Select-Object -Property * } -argumentlist $File -Session $session
    #$RetrievedFileProperties | Select-Object -Property * | Export-Csv "$LocalSavePath\File Details (Properties).csv" -NoTypeInformation
    #$RetrievedFileProperties | Select-Object -Property * | Export-Clixml "$LocalSavePath\File Details (Properties).xml"
    "====================================================================================================" | Out-File $RetrievedFileSavePath
    "Properties" | Add-Content $RetrievedFileSavePath
    ...
    "====================================================================================================" | Add-Content $RetrievedFileSavePath
    "Hashes" | Add-Content $RetrievedFileSavePath
    "====================================================================================================" | Add-Content $RetrievedFileSavePath
    ...
    $RetrievedFileAuthenticodeSignature = Invoke-Command -ScriptBlock { param($File) Get-AuthenticodeSignature "$($File.FullName)" | Select-Object -Property * } -argumentlist $File -Session $session
