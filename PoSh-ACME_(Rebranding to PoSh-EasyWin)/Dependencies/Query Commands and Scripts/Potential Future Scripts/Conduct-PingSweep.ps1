function Global:Conduct-PingSweep {
    ...
    $ProgressBarEndpointsProgressBar.Maximum = $IpTotal
    $ProgressBarEndpointsProgressBar.Value   = 0
    $ProgressBarQueriesProgressBar.Maximum = $IpTotal
    ...
    $IPrange | foreach {
        ...
        $ProgressBarEndpointsProgressBar.Value   = ($index / $IpTotal) * 100
        $ProgressBarQueriesProgressBar.Value   = (($index - $pending)/$IpTotal * 100)
