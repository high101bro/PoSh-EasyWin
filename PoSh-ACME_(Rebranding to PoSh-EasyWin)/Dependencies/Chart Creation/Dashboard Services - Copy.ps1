...
$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses = $script:ServiceAutoChart01CSVFileMatch | Select-Object -Last 1
$script:ServiceAutoChartDataSourceServices = $null
$script:ServiceAutoChartDataSourceServices = Import-Csv $script:ServiceAutoChartCSVFileMostRecentCollectionProcesses
...
$AutoChartSelectFileButton.Add_Click({
    ...
    $script:ServiceAutoChartDataSourceServices = Import-Csv $($AutoChartOpenResultsOpenFileDialog.filename)

    Generate-ServicesAutoChart01 -Filter 'Running'
        $script:ServiceAutoChart01FilterComboBox.Text = ''
    Generate-ServicesAutoChart02 -Filter 'Running'
        $script:ServiceAutoChart02FilterComboBox.Text = ''
    Generate-ServicesAutoChart03 -Filter 'Auto'
        $script:ServiceAutoChart03FilterComboBox.Text = ''
    Generate-ServicesAutoChart04 -Filter 'LocalSystem'
        $script:ServiceAutoChart04FilterComboBox.Text = ''
...
$script:ServiceAutoChart01OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart01.Location.X + 5
                   Y = $script:ServiceAutoChart01.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart01ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart01.Size.Height - 125 }
...
$script:ServiceAutoChart01TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    ...
    Location    = @{ X = $script:ServiceAutoChart01TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart01TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart013DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart01ChartTypeComboBox.Location.X + $script:ServiceAutoChart01ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart01CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart01TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart01TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart01TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart01Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart01SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart01Results.Location.X
                  Y = $script:ServiceAutoChart01Results.Location.Y + $script:ServiceAutoChart01Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart01SaveButton.Add_Click({
    ...
    If ($Result) { $script:ServiceAutoChart01.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart01NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart01SaveButton.Location.X 
                        Y = $script:ServiceAutoChart01SaveButton.Location.Y + $script:ServiceAutoChart01SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
...
$script:ServiceAutoChart02.Series["Running Services Per Host"].ChartType         = 'Column'
$script:ServiceAutoChart02.Series["Running Services Per Host"].Color             = 'Blue'
        ...
        function Generate-ServicesAutoChart02 ($Filter) {
            ...
            if ($script:ServiceAutoChart02UniqueDataFields.count -gt 0){
                ...
                $script:ServiceAutoChart02OverallDataResults += $AutoChart02YDataResults
                $script:ServiceAutoChart02OverallDataResults | ForEach-Object { $script:ServiceAutoChart02.Series["Running Services Per Host"].Points.AddXY($_.Computer,$_.ResultsCount) }

                $script:ServiceAutoChart02.Series["Running Services Per Host"].Points.Clear()
                $script:ServiceAutoChart02OverallDataResults | Sort-Object -Property UniqueCount | Select-Object -skip $script:ServiceAutoChart02TrimOffFirstTrackBarValue | Select-Object -SkipLast $script:ServiceAutoChart02TrimOffLastTrackBarValue | ForEach-Object {$script:ServiceAutoChart02.Series["Running Services Per Host"].Points.AddXY($_.Computer,$_.ResultsCount)}
...
$script:ServiceAutoChart02OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart02.Location.X + 5
                   Y = $script:ServiceAutoChart02.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart02ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart02.Size.Height - 125 }
...
$script:ServiceAutoChart02TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart02TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart02TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart023DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart02ChartTypeComboBox.Location.X + $script:ServiceAutoChart02ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart02CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart02TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart02TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart02TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart02Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart02SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart02Results.Location.X
                    Y = $script:ServiceAutoChart02Results.Location.Y + $script:ServiceAutoChart02Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                    Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart02SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart02.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart02NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart02SaveButton.Location.X 
                        Y = $script:ServiceAutoChart02SaveButton.Location.Y + $script:ServiceAutoChart02SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart03OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart03.Location.X + 5
                   Y = $script:ServiceAutoChart03.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart03ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart03.Size.Height - 125 }
...
$script:ServiceAutoChart03TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart03TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart03TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart033DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart03ChartTypeComboBox.Location.X + $script:ServiceAutoChart03ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart03CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart03TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart03TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart03TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart03Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart03SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart03Results.Location.X
                  Y = $script:ServiceAutoChart03Results.Location.Y + $script:ServiceAutoChart03Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart03SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart03.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart03NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart03SaveButton.Location.X 
                        Y = $script:ServiceAutoChart03SaveButton.Location.Y + $script:ServiceAutoChart03SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart04OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart04.Location.X + 5
                   Y = $script:ServiceAutoChart04.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart04ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart04.Size.Height - 125 }
...
$script:ServiceAutoChart04TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart04TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart04TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart043DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart04ChartTypeComboBox.Location.X + $script:ServiceAutoChart04ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart04CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart04TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart04TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart04TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart04Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart04SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart04Results.Location.X
                  Y = $script:ServiceAutoChart04Results.Location.Y + $script:ServiceAutoChart04Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart04SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart04.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart04NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart04SaveButton.Location.X 
                        Y = $script:ServiceAutoChart04SaveButton.Location.Y + $script:ServiceAutoChart04SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
[ No data not available ]`n
Run 'Get-EnrichedServices' to obtain Network Connections
...
$script:ServiceAutoChart05OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart05.Location.X + 5
                   Y = $script:ServiceAutoChart05.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart05ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart05.Size.Height - 125 }
...
$script:ServiceAutoChart05TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart05TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart05TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart053DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart05ChartTypeComboBox.Location.X + $script:ServiceAutoChart05ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart05CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart05TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart05TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart05TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart05Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart05SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart05Results.Location.X
                  Y = $script:ServiceAutoChart05Results.Location.Y + $script:ServiceAutoChart05Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart05SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart05.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart05NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart05SaveButton.Location.X 
                        Y = $script:ServiceAutoChart05SaveButton.Location.Y + $script:ServiceAutoChart05SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart06.Series["Accounts That Started Services"].Color             = 'Gray'
        ...
        function Generate-ServicesAutoChart06 {
            ...
            $script:ServiceAutoChart06UniqueDataFields  = $script:ServiceAutoChartDataSourceServices | Select-Object -Property 'Name' | Sort-Object -Property 'Name' -Unique
            ...
            if ($script:ServiceAutoChart06UniqueDataFields.count -gt 0){
                ...
                $script:ServiceAutoChart06OverallDataResults | Sort-Object -Property UniqueCount | ForEach-Object { $script:ServiceAutoChart06.Series["Accounts That Started Services"].Points.AddXY($_.DataField.Name,$_.UniqueCount) }
...
[ No data not available ]`n
Run 'Get-WmiOBject Win32_Service' to obtain Account Start Name data`n`n"                
            }
        }
        Generate-ServicesAutoChart06
...
$script:ServiceAutoChart06OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart06.Location.X + 5
                   Y = $script:ServiceAutoChart06.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart06ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart06.Size.Height - 125 }
...
$script:ServiceAutoChart06TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart06TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart06TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart063DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart06ChartTypeComboBox.Location.X + $script:ServiceAutoChart06ChartTypeComboBox.Size.Width + 10
...
function script:InvestigateDifference-AutoChart06 {    
    # List of Positive Endpoints that positively match
    $script:ServiceAutoChart06ImportCsvPosResults = $script:ServiceAutoChartDataSourceServices | Where-Object 'Name' -eq $($script:ServiceAutoChart06InvestDiffDropDownComboBox.Text) | Select-Object -ExpandProperty 'PSComputerName' -Unique
...
$script:ServiceAutoChart06CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart06TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart06TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart06TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart06CheckDiffButton.Add_Click({
    $script:ServiceAutoChart06InvestDiffDropDownArray = $script:ServiceAutoChartDataSourceServices | Select-Object -Property 'Name' -ExpandProperty 'Name' | Sort-Object -Unique
...
$script:ServiceAutoChart06Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart06SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart06Results.Location.X
                  Y = $script:ServiceAutoChart06Results.Location.Y + $script:ServiceAutoChart06Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart06SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart06.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart06NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart06SaveButton.Location.X 
                        Y = $script:ServiceAutoChart06SaveButton.Location.Y + $script:ServiceAutoChart06SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart07OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart07.Location.X + 5
                   Y = $script:ServiceAutoChart07.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart07ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart07.Size.Height - 125 }
...
$script:ServiceAutoChart07TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart07TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart07TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart073DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart07ChartTypeComboBox.Location.X + $script:ServiceAutoChart07ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart07CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart07TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart07TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart07TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart07Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart07SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart07Results.Location.X
                  Y = $script:ServiceAutoChart07Results.Location.Y + $script:ServiceAutoChart07Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart07SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart07.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart07NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart07SaveButton.Location.X 
                        Y = $script:ServiceAutoChart07SaveButton.Location.Y + $script:ServiceAutoChart07SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart08OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart08.Location.X + 5
                   Y = $script:ServiceAutoChart08.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart08ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart08.Size.Height - 125 }
...
$script:ServiceAutoChart08TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart08TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart08TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart083DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart08ChartTypeComboBox.Location.X + $script:ServiceAutoChart08ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart08CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart08TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart08TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart08TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart08Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart08SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart08Results.Location.X
                  Y = $script:ServiceAutoChart08Results.Location.Y + $script:ServiceAutoChart08Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart08SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart08.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart08NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart08SaveButton.Location.X 
                        Y = $script:ServiceAutoChart08SaveButton.Location.Y + $script:ServiceAutoChart08SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
...
$script:ServiceAutoChart09OptionsButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart09.Location.X + 5
                   Y = $script:ServiceAutoChart09.Location.Y + 346 }
    Size      = @{ Width  = 75
                   Height = 20 }
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
    ForeColor = "Black"
...
$script:ServiceAutoChart09ManipulationPanel = New-Object System.Windows.Forms.Panel -Property @{
    Location    = @{ X = 0
                     Y = $script:ServiceAutoChart09.Size.Height - 125 }
...
$script:ServiceAutoChart09TrimOffLastGroupBox = New-Object System.Windows.Forms.GroupBox -Property @{
    Text        = "Trim Off Last: 0"
    Location    = @{ X = $script:ServiceAutoChart09TrimOffFirstGroupBox.Location.X + $script:ServiceAutoChart09TrimOffFirstGroupBox.Size.Width + 10
...
$script:ServiceAutoChart093DToggleButton = New-Object Windows.Forms.Button -Property @{
    Text      = "3D Off"
    Location  = @{ X = $script:ServiceAutoChart09ChartTypeComboBox.Location.X + $script:ServiceAutoChart09ChartTypeComboBox.Size.Width + 10
...
$script:ServiceAutoChart09CheckDiffButton = New-Object Windows.Forms.Button -Property @{
    ...
    Location  = @{ X = $script:ServiceAutoChart09TrimOffLastGroupBox.Location.X + $script:ServiceAutoChart09TrimOffLastGroupBox.Size.Width + 5
                   Y = $script:ServiceAutoChart09TrimOffLastGroupBox.Location.Y }
    Size      = @{ Width  = 140
                   Height = 25 }
    Anchor    = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font      = New-Object System.Drawing.Font("$Font",11,0,0,0)
...
$script:ServiceAutoChart09Results.Add_Click({ $script:ServiceAutoChartDataSourceServices | Out-GridView -Title "$script:ServiceAutoChartCSVFileMostRecentCollectionProcesses" }) 
...
$script:ServiceAutoChart09SaveButton = New-Object Windows.Forms.Button -Property @{
    Text     = "Save Chart"
    Location = @{ X = $script:ServiceAutoChart09Results.Location.X
                  Y = $script:ServiceAutoChart09Results.Location.Y + $script:ServiceAutoChart09Results.Size.Height + 5 }
    Size     = @{ Width  = 140
                  Height = 25 }
    Font     = New-Object System.Drawing.Font("$Font",11,0,0,0)
    BackColor = "LightGray"
...
$script:ServiceAutoChart09SaveButton.Add_Click({
    $Result = script:Invoke-SaveChartAsImage
    If ($Result) { $script:ServiceAutoChart09.SaveImage($Result.FileName, $Result.Extension) }
})
...
$script:ServiceAutoChart09NoticeTextbox = New-Object System.Windows.Forms.Textbox -Property @{
    Location    = @{ X = $script:ServiceAutoChart09SaveButton.Location.X 
                        Y = $script:ServiceAutoChart09SaveButton.Location.Y + $script:ServiceAutoChart09SaveButton.Size.Height + 5 }
    Size        = @{ Width  = 140
                        Height = 25 }
    Anchor      = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    Font        = New-Object System.Drawing.Font("Courier New",11,0,0,0)
