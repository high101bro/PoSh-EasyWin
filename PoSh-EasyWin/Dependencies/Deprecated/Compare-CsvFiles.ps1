...
$CompareButton.text     = "Compare CSVs"
$CompareButton.Location = New-Object System.Drawing.Point(($OpenCsvResultsButton.Location.X + $OpenCsvResultsButton.Size.Width + 5),$OpenCsvResultsButton.Location.Y)
$CompareButton.Size     = New-Object System.Drawing.Size(115,22)
CommonButtonSettings -Button $CompareButton
