...
$script:AutoChart04.Series["When Password Last Set"].Color             = 'Brown'
...
$script:AutoChart05.Series["Last Security Descriptor Core Propagation Data"].Color             = 'Gray'
...
$script:AutoChart07.Series["Locked Computers"].Color             = 'Gray'
