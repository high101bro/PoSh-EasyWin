    ...
    if ($script:SelectedDomainController -ne $null) {
        ...
        if ($AutoChartPullNewDataCheckBoxedRadioButton.checked) {
            if ($script:ComputerList.count -eq 0) {
                ...
                $ScriptBlockProgressBarInput = { Update-AutoChartsActiveDirectoryGroups -ComputerNameList $script:ComputerList }
                Launch-ProgressBarForm -FormTitle 'Progress Bar' -ScriptBlockProgressBarInput $ScriptBlockProgressBarInput
            }
        }
        ...
        Generate-AutoChart07ADGroups
        Generate-AutoChart08ADGroups
        Generate-AutoChart09ADGroups
        Generate-AutoChart10ADGroups
        Generate-AutoChart11ADGroups
        Generate-AutoChart12ADGroups
    }
})
